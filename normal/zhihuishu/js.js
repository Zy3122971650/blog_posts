webpackJsonp([0], Array(175).concat([function(t, e, i) {
    ...
    var o = i(266),
        ...
        s = function(t, e, i) {
            ...
            n.setTime(n.getTime() + 24 * o * 60 * 60 * 1e3),
                document.cookie = t + "=" + e + ";expires=" + n.toGMTString() + ";path=/"
        },
        l = function(t) {
        ...
        d = function(t) {
            var e = 0,
                ...
                n = 0;
            return t = Number(t),
                t <= 0 || (t < 10 ? parseInt(t) : 10 <= t && t < 60 ? parseInt(t) : 60 <= t && t < 600 ? (i = Math.floor(t / 60),
                    n = parseInt(t % 60)) : 600 <= t && t < 3600 ? (i = Math.floor(t / 60),
                    n = parseInt(t % 60)) : 3600 <= t && (e = Math.floor(t / 3600))),
                i = Math.floor((t - 3600 * e) / 60),
                n = parseInt(t % 60),
                "0" + e + ":" + (i < 10 ? "0" + i : i) + ":" + (n < 10 ? "0" + n : n)
        },
        u = function(t) {
            return $.trim(t),
                null == t || void 0 == t || "undefined" == t || "" == t || 0 == t.length || !/[^(^\s*)|(\s*$)]/.test(t)
        }
}, , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , function(t, e, i) {
    function n(t) {
        i(839)
    ...
    function s(t, e) {
        ...
        return w(e, function(t, n) {
                if (S(t)) {
                    ...
                    for (var o = 0; o < i.length; o++) {
                        var a = i[o].exist;
                        if (!(i[o].option || null != a.id && null != t.id || null == t.name || u(t) || u(a) || a.name !== t.name + ""))
                            return i[o].option = t,
                                void(e[n] = null)
                    }
                }
    ...
    function l(t) {
        ...
        w(t, function(t, i) {
            ...
            w(t, function(t, i) {
                var n = t.option;
                x.assert(!n || null == n.id || !e.get(n.id) || e.get(n.id) === t, "id duplicates: " + (n && n.id)),
            ...
            w(t, function(t, i) {
                var n = t.exist,
                    ...
                    a = t.keyInfo;
                if (S(o)) {
                    if (a.name = null != o.name ? o.name + "" : n ? n.name : k + i,
                        n)
                        a.id = n.id;
                    else if (null != o.id)
                        a.id = o.id + "";
    ...
    e.normalizeToArray = n,
        e.defaultEmphasis = o,
        e.TEXT_STYLE_OPTIONS = I,
        e.getDataItemValue = a,
        e.isDataItemOption = r,
        e.mappingToExists = s,
        e.makeIdAndName = l,
        e.isNameSpecified = d,
        e.isIdInner = u,
    ...
    function c(t, e, i) {
        ...
        for (var o = Math.pow(10, i), a = b.map(t, function(t) {
            ...
            for (var u = Number.NEGATIVE_INFINITY, c = null, h = 0, f = d.length; h < f; ++h)
                d[h] > u && (u = d[h],
                    c = h);
            ++s[c],
                d[c] = 0,
    ...
    n.prototype = {
            ...
            brush: function(t, e) {
                ...
                if (i.bind(t, this, e),
                    ...
                    this.__dirty) {
                    var p;
                    l && (p = p || this.getBoundingRect(),
                            this._fillGradient = i.getGradient(t, r, p)),
                        u && (p = p || this.getBoundingRect(),
                            this._strokeGradient = i.getGradient(t, s, p))
                }
                l ? t.fillStyle = this._fillGradient : h && (t.fillStyle = d.call(r, t)),
                    u ? t.strokeStyle = this._strokeGradient : f && (t.strokeStyle = d.call(s, t));
                var g = i.lineDash,
                    v = i.lineDashOffset,
                    m = !!t.setLineDash,
                    _ = this.getGlobalScale();
                if (n.setScale(_[0], _[1], this.segmentIgnoreThreshold),
                    this.__dirtyPath || g && !m && o ? (n.beginPath(t),
                        g && !m && (n.setLineDash(g),
                            n.setLineDashOffset(v)),
            ...
            contain: function(t, e) {
                ...
                if (t = i[0],
                    ...
                    if (o.hasStroke()) {
                        ...
                        if (l > 1e-10 && (o.hasFill() || (r = Math.max(r, this.strokeContainThreshold)),
                                s.containStroke(a, r / l, t, e)))
                            return !0
                    }
                    if (o.hasFill())
            ...
            attrKV: function(t, e) {
                "shape" === t ? (this.setShape(e),
                    this.__dirtyPath = !0,
                    this._rect = null) : o.prototype.attrKV.call(this, t, e)
            },
        ...
        n.extend = function(t) {
            var e = function(e) {
                ...
                if (i) {
                    ...
                    var o = this.shape;
                    for (var a in i)
                        !o.hasOwnProperty(a) && i.hasOwnProperty(a) && (o[a] = i[a])
                }
    ...
    (function(t) {
        var i;
        "undefined" != typeof window ? i = window.__DEV__ : void 0 !== t && (i = t.__DEV__),
            void 0 === i && (i = !0);
        var n = i;
        e.__DEV__ = n
    }).call(e, i(64))
    ...
    n.prototype = {
            ...
            union: function(t) {
                ...
                this.width = l(t.x + t.width, this.x + this.width) - e,
                    this.height = l(t.y + t.height, this.y + this.height) - i,
                    this.x = e,
                    this.y = i
            },
                ...
                return function(o) {
                    if (o) {
                        t[0] = i[0] = this.x,
                            ...
                            r(i, i, o),
                            r(n, n, o),
                            this.x = s(t[0], e[0], i[0], n[0]),
                            this.y = s(t[1], e[1], i[1], n[1]);
            ...
            calculateTransform: function(t) {
                var e = this,
                    ...
                    n = t.height / e.height,
                    o = a.create();
                return a.translate(o, o, [-e.x, -e.y]),
                    a.scale(o, o, [i, n]),
                    a.translate(o, o, [t.x, t.y]),
                    o
            },
    ...
    function s(t, e, i, n) {
        ...
        return i && ("center" === n && (i = d(i, o.getBoundingRect())),
                u(o, i)),
            o
    }
    ...
    function d(t, e) {
        var i, n = e.width / e.height,
            o = t.height * n;
        return o <= t.width ? i = t.height : (o = t.width,
            i = o / n), {
            x: t.x + t.width / 2 - o / 2,
    ...
    function c(t) {
        return kt.subPixelOptimizeLine(t.shape, t.shape, t.style),
            t
    }

    function h(t) {
        return kt.subPixelOptimizeRect(t.shape, t.shape, t.style),
            t
    }
    ...
    function y(t, e, i) {
        var n, o = Pt,
            a = Pt;
        t.__highlighted && (o = Lt,
                n = !0),
            e(t, i),
            t.__highlighted && (a = Lt,
                n = !0),
    ...
    function T(t, e) {
        ...
        if (t.__highDownSilentOnTouch = t.highDownSilentOnTouch,
            t.__highDownOnUpdate = t.highDownOnUpdate, !i || t.__highDownDispatcher) {
            var n = i ? "off" : "on";
            t[n]("mouseover", b)[n]("mouseout", w),
                t[n]("emphasis", S)[n]("normal", C),
    ...
    function A(t, e, i, n, o, a, r) {
        ...
        var s, l = o.labelFetcher,
            ...
            h = i.getShallow("show"),
            f = n.getShallow("show");
        (h || f) && (l && (s = l.getFormattedLabel(d, "normal", null, u, c)),
            null == s && (s = et.isFunction(o.defaultText) ? o.defaultText(d, o) : o.defaultText));
        var p = h ? s : null,
            g = f ? et.retrieve2(l ? l.getFormattedLabel(d, "emphasis", null, u, c) : null, s) : null;
        null == p && null == g || (P(t, i, a, o),
                P(e, n, r, o, !0)),
            t.text = p,
            e.text = g
    }
    ...
    function R(t, e, i, n) {
        if (i = i || Dt,
            ...
            null != a && (a *= Math.PI / 180),
                t.textRotation = a,
                t.textDistance = et.retrieve2(e.getShallow("distance"), n ? null : 5)
        }
        var r, s = e.ecModel,
    ...
    function z(t, e, i, n, o, a) {
        i = !o && i || Dt,
            t.textFill = N(e.getShallow("color"), n) || i.color,
            t.textStroke = N(e.getShallow("textBorderColor"), n) || i.textBorderColor,
            t.textStrokeWidth = et.retrieve2(e.getShallow("textBorderWidth"), i.textBorderWidth),
            ...
            a && n.disableBox || (t.textBackgroundColor = N(e.getShallow("backgroundColor"), n),
                t.textPadding = e.getShallow("padding"),
                t.textBorderColor = N(e.getShallow("borderColor"), n),
    ...
    function H(t, e, i, n, o, a) {
        if ("function" == typeof o && (a = o,
            ...
            "function" == typeof d && (d = d(o, n.getAnimationDelayParams ? n.getAnimationDelayParams(e, o) : null)),
                "function" == typeof s && (s = s(o)),
                s > 0 ? e.animateTo(i, s, d || 0, l, a, !!a) : (e.stopAnimation(),
                    e.attr(i),
                    a && a())
        } else
            e.stopAnimation(),
    ...
    function U(t, e) {
        for (var i = ot.identity([]); t && t !== e;)
            ot.mul(i, t.getLocalTransform(), i),
            t = t.parent;
        return i
    }

    function j(t, e, i) {
        return e && !et.isArrayLike(e) && (e = st.getLocalTransform(e)),
            i && (e = ot.invert([], e)),
            at.applyTransform([], t, e)
    }
    ...
    function X(t, e, i, n) {
        function o(t) {
            ...
            return t.shape && (e.shape = et.extend({}, t.shape)),
                e
        }
        if (t && e) {
            var a = function(t) {
    ...
    function Z(t, e, i) {
        ...
        if (i = i || {
            ...
            return 0 === t.indexOf("image://") ? (n.image = t.slice(8),
                et.defaults(n, i),
                new lt(e)) : s(t.replace("path://", ""), e, i, "center")
    }

    function Q(t, e, i, n, o) {
        for (var a = 0, r = o[o.length - 1]; a < o.length; a++) {
            var s = o[a];
            if (K(t, e, i, n, s[0], s[1], r[0], r[1]))
                return !0;
            r = s
        }
    }
    ...
    a("circle", ct),
        ...
        a("bezierCurve", _t),
        a("arc", yt),
        e.Z2_EMPHASIS_LIFT = Mt,
        e.CACHED_LABEL_STYLE_PROPERTIES = At,
        e.extendShape = n,
        e.extendPath = o,
        e.registerShape = a,
        e.getShapeClass = r,
        ...
        e.subPixelOptimizeRect = h,
        e.subPixelOptimize = Nt,
        e.setElementHoverStyle = x,
        e.setHoverStyle = I,
        e.setAsHighDownDispatcher = T,
        e.isHighDownDispatcher = D,
        e.getHighlightDigit = M,
        e.setLabelStyle = A,
        e.modifyLabelStyle = L,
        e.setTextStyle = P,
        e.setText = O,
        e.getFont = V,
        e.updateProps = q,
        ...
        e.getTransform = U,
        e.applyTransform = j,
        e.transformDirection = G,
        e.groupTransition = X,
        e.clipPointsByRect = Y,
        e.clipRectByRect = $,
        e.createIcon = Z,
        e.linePolygonIntersect = Q,
        e.lineLineIntersect = K
}, function(t, e, i) {
    function n(t, e) {
        return function(i, n, o) {
            if (!e && this._disposed)
                return void this.id;
            i = i && i.toLowerCase(),
                it.prototype[t].call(this, i, n, o)
        }
    }
    ...
    function a(t, e, i) {
        ...
        e && st(e, !0),
            ...
            this._componentsMap = {},
            this._coordSysMgr = new at;
        var r = this._api = S(this);
        et(jt, n),
            et(qt, n),
            this._scheduler = new xt(this, r, qt, jt),
            it.call(this, this._ecEventProcessor = new C),
            this._messageCenter = new o,
            this._initEvents(),
            this.resize = K.bind(this.resize, this),
            this._pendingActions = [],
            a.animation.on("frame", this._onframe, this),
            f(a, this),
            K.setAsPrimitive(this)
    }
    ...
    function l(t, e, i, n, o) {
        ...
        var r = t._model;
        if (!n)
            return void kt(t._componentsViews.concat(t._chartsViews), a);
        var s = {};
        s[n + "Id"] = i[n + "Id"],
            s[n + "Index"] = i[n + "Index"],
            s[n + "Name"] = i[n + "Name"];
        ...
        null != d && (d = K.createHashMap(pt.normalizeToArray(d))),
            r && r.eachComponent(l, function(e) {
    ...
    function u(t, e) {
        ...
        var u = [t],
            c = !1;
        t.batch && (c = !0,
            u = K.map(t.batch, function(e) {
                return e = K.defaults(K.extend({}, e), t),
                    e.batch = null,
                    e
            }));
        var h, f = [],
        ...
        kt(u, function(t) {
                h = o.action(t, this._model, this._api),
                    h = h || K.extend({}, t),
                    h.type = a.event || h.type,
                    f.push(h),
                    p ? l(this, d, t, "series") : r && l(this, d, t, r.main, r.sub)
            }, this),
            "none" === d || p || r || (this[Et] ? (s(this),
                Bt.update.call(this, t),
                this[Et] = !1) : Bt[d].call(this, t)),
            h = c ? {
                type: a.event || i,
                escapeConnect: n,
                batch: f
            } : f[0],
            this[Rt] = !1, !e && this._messageCenter.trigger(h.type, h)
    }
    ...
    function p(t, e, i, n) {
        function o(t) {
            ...
            if (!o) {
                var u = Dt(t.type);
                o = new(a ? ct.getClass(u.main, u.sub) : ht.getClass(u.sub)),
                    o.init(i, d),
                    s[e] = o,
                    r.push(o),
                    l.add(o.group)
        ...
        for (var a = "component" === e, r = a ? t._componentsViews : t._chartsViews, s = a ? t._componentsMap : t._chartsMap, l = t._zr, d = t._api, u = 0; u < r.length; u++)
            r[u].__alive = !1;
    ...
    function M(t) {
        "string" == typeof t ? t = Yt[t] : t instanceof a || (t = A(t)),
            t instanceof a && !t.isDisposed() && t.dispose()
    }
    ...
    var St = i(793),
        ...
        Et = "__optionUpdated",
        zt = /^[a-zA-Z0-9_]+$/;
    o.prototype.on = n("on", !0),
        o.prototype.off = n("off", !0),
        o.prototype.one = n("one", !0),
        K.mixin(o, it);
    var Nt = a.prototype;
    Nt._onframe = function() {
        ...
        Nt.setOption = function(t, e, i) {
            if (this._disposed)
                return void this.id;
            var n;
            if (Tt(e) && (i = e.lazyUpdate,
                    n = e.silent,
                    e = e.notMerge),
                this[Rt] = !0, !this._model || e) {
                ...
                if ($t[i]) {
                    ...
                    if (p.resize({
                        ...
                        return kt(d, function(t) {
                            ...
                            t.connectedBackgroundColor && p.painter.setBackgroundColor(t.connectedBackgroundColor),
                    ...
                    return t.connectedBackgroundColor && p.add(new ft.Rect({
                        ...
                        p.refreshImmediately(),
                        f.toDataURL("image/" + (t && t.type || "png"))
                }
                return this.getDataURL(t)
            }
        },
        Nt.convertToPixel = K.curry(r, "convertToPixel"),
        Nt.convertFromPixel = K.curry(r, "convertFromPixel"),
        Nt.containPixel = function(t, e) {
            if (this._disposed)
                return void this.id;
            var i, n = this._model;
            return t = pt.parseFinder(n, t),
    ...
    var Bt = {
        ...
        updateView: function(t) {
            var e = this._model;
            e && (ht.markUpdateMethod(t, "updateView"),
                g(e),
                this._scheduler.performVisualTasks(e, t, {
                    setDirty: !0
                }),
                v(this, this._model, this._api, t),
                y(e, this._api))
        },
    ...
    Nt.resize = function(t) {
        ...
        Nt.dispatchAction = function(t, e) {
            ...
            if (Tt(e) || (e = {
                ...
                u.call(this, t, e.silent),
                    e.flush ? this._zr.flush(!0) : !1 !== e.flush && tt.browser.weChat && this._throttledZrFlush(),
                    c.call(this, e.silent),
                    h.call(this, e.silent)
            }
        },
    ...
    Nt._initEvents = function() {
            kt(Ft, function(t) {
                    var e = function(e) {
                        ...
                        if ("globalout" === t)
                            ...
                            o && o.eventData && (i = K.extend({}, o.eventData));
                        if (i) {
        ...
        Nt.dispose = function() {
            if (this._disposed)
                return void this.id;
            this._disposed = !0,
                pt.setAttribute(this.getDom(), Kt, "");
            var t = this._api,
                e = this._model;
    ...
    e.version = "4.9.0",
        ...
        e.disconnect = Jt,
        e.dispose = M,
        e.getInstanceByDom = A,
        e.getInstanceById = L,
        e.registerTheme = P,
        e.registerPreprocessor = O,
        e.registerProcessor = R,
        e.registerPostUpdate = E,
        e.registerAction = z,
        e.registerCoordinateSystem = N,
        e.getCoordinateSystemDimensions = B,
        e.registerLayout = F,
        e.registerVisual = V,
        e.registerLoading = q,
        e.extendComponentModel = W,
        e.extendComponentView = U,
        e.extendSeriesModel = j,
        e.extendChartView = G,
        e.setCanvasCreator = X,
        e.registerMap = Y,
        e.getMap = $,
        e.dataTool = te;
    var ee = i(797);
    ...
    function r(t, e, i, n, a, r, s) {
        ...
        var h = u.outerHeight,
            ...
            p = d(0, h, n),
            g = new w(f, p, c, h);
        return g.lineHeight = u.lineHeight,
            g
    }
    ...
    function y(t, e) {
        ...
        for (var m = 0; m < s.length; m++) {
            for (var _ = s[m], y = 0, b = 0, w = 0; w < _.tokens.length; w++) {
                ...
                if (I && (A += I[0] + I[2]),
                    C.height = A,
                    C.lineHeight = D(k.textLineHeight, e.textLineHeight, A),
                    C.textAlign = k && k.textAlign || e.textAlign,
                    C.textVerticalAlign = k && k.textVerticalAlign || "middle",
                    null != g && l + C.lineHeight > g)
                    return {
                        lines: [],
                        width: 0,
                        height: 0
                ...
                var L = k.textWidth,
                    P = null == L || "auto" === L;
                if ("string" == typeof L && "%" === L.charAt(L.length - 1))
                    C.percentWidth = L,
                    u.push(C),
                    L = 0;
                else {
                    if (P) {
                        ...
                        var R = k.textBackgroundColor,
                            E = R && R.image;
                        E && (E = S.findExistImage(E),
                            S.isImageReady(E) && (L = Math.max(L, E.width * A / E.height)))
                    }
                    var z = I ? I[1] + I[3] : 0;
                    L += z;
                    var N = null != p ? p - b : null;
                    null != N && N < L && (!P || N < z ? (C.text = "",
                        C.textWidth = L = 0) : (C.text = h(C.text, N - z, M, f.ellipsis, {
                            minChar: f.minChar
                        }),
                        C.textWidth = o(C.text, M),
                        L = C.textWidth + z))
        ...
        i.outerWidth = i.width = T(e.textWidth, d),
            i.outerHeight = i.height = T(e.textHeight, l),
            c && (i.outerWidth += c[1] + c[3],
                i.outerHeight += c[0] + c[2]);
    ...
    E.measureText = function(t, e) {
        ...
        e.adjustTextX = l,
        e.adjustTextY = d,
        e.calculateTextPosition = u,
        e.adjustTextPositionOnRect = c,
        e.truncateText = h,
        e.getLineHeight = v,
        e.measureText = m,
        e.parsePlainText = _,
    ...
    var c = i(634),
        ...
        g = 0;
    e.parseClassType = n,
        e.enableClassExtend = a,
        e.enableClassCheck = r,
        e.enableClassManagement = d,
        e.setReadOnly = u
}, function(t, e, i) {
    function n(t) {
    ...
    var n = /^([+-])?0*(\d+)(\.(\d+))?$/,
        ...
        a = e.e2ten = function(t) {
            ...
            if (a > 0) {
                var r = n.substr(0, a);
                r = r.length < a ? r + new Array(a - r.length + 1).join("0") : r,
                    n = n.substr(a),
                    i += r
            } else {
                a = -a;
                ...
                s = s < 0 ? 0 : s;
                var l = i.substr(s, a);
                l = l.length < a ? new Array(a - l.length + 1).join("0") + l : l,
                    i = i.substring(0, s),
                    n = l + n
            }
            return i = "" == i ? "0" : i,
    ...
    e.getNumbResult = function(t) {
            ...
            if (!e && o.test(t.toString()) && (e = n.exec(a(t.toString()))),
                e)
                return {
                    int: e[2],
                    decimal: e[4],
        ...
        e.centerArray = function t(e, i) {
            if (e.splice.apply(e, [0, i.length].concat(i.splice(0, i.length))),
                arguments.length > 2) {
    ...
    function s(t, e, i, n, o) {
        ...
        if (e === O)
            ...
            a = o ? o.length : i === B ? t.length : t[0] ? t[0].length : null;
        else if (e === R)
            o || (o = u(t));
        else if (e === E)
            o || (o = [],
    ...
    function d(t, e, i, n) {
        if (null == n && (n = 1 / 0),
            ...
            for (var a = i[0] || [], o = 0; o < a.length && o < n; o++)
                t(a[o], o)
    }
    ...
    function c(t, e, i) {
        ...
        return w(t, function(t, e) {
            ...
            d.length && (a.itemName = d),
            u.length && (a.seriesName = u),
            a
    }
    ...
    function h(t, e, i) {
        ...
        var s = function() {
            ...
            for (var n = {}, s = {}, l = [], d = 0, u = Math.min(5, i); d < u; d++) {
                ...
                l.push(c);
                var h = c === F.Not;
                if (h && null == n.v && d !== o && (n.v = d),
                    (null == n.n || n.n === n.v || !h && l[n.n] === F.Not) && (n.n = d),
                    t(n) && l[n.n] !== F.Not)
                    return n;
                h || (c === F.Might && null == s.v && d !== o && (s.v = d),
                    null != s.n && s.n !== s.v || (s.n = d))
            }
    ...
    var v = i(634),
        ...
        V = _();
    e.BE_ORDINAL = F,
        e.detectSourceFormat = n,
        e.getSource = o,
        e.resetSourceDefaulter = a,
        e.prepareSource = r,
        e.makeSeriesEncodeForAxisCoordSys = c,
        e.makeSeriesEncodeForNameBased = h,
        e.guessOrdinal = p
}, function(t, e, i) {
    function n(t) {
        var e = [];
        return o.each(g.getClassesByMainType(t), function(t) {
            ...
            "dataset" !== t && o.indexOf(e, "dataset") <= 0 && e.unshift("dataset"),
            e
    }
    var o = i(630),
        a = i(646),
    ...
    l(g, {
        ...
        r.enableSubTypeDefaulter(g),
        r.enableTopologicalTravel(g, n),
        o.mixin(g, f);
    var v = g;
    t.exports = v
}, function(t, e, i) {
    ...
    n.prototype = {
            ...
            getModel: function(t, e) {
                ...
                return e = e || (i = a(this, t)) && i.getModel(t),
                    new n(r, e, this.ecModel)
            },
            isEmpty: function() {
            ...
            clone: function() {
                return new(0,
                    this.constructor)(r.clone(this.option))
            },
    ...
    function a(t, e, i) {
        ...
        var n = e.width,
            ...
            f = i[1] + i[3],
            v = t.aspect;
        switch (isNaN(d) && (d = n - s - f - a),
            isNaN(u) && (u = o - l - c - r),
            null != v && (isNaN(d) && isNaN(u) && (v > n / o ? d = .8 * n : u = .8 * o),
                isNaN(d) && (d = v * u),
                isNaN(u) && (u = d / v)),
            isNaN(a) && (a = n - s - d - f),
            isNaN(r) && (r = o - l - u - c),
    ...
    function r(t, e, i, n, o) {
        ...
        if (r || s) {
            var d;
            if ("raw" === l)
                d = "group" === t.type ? new h(0, 0, +e.width || 0, +e.height || 0) : t.getBoundingRect();
            else if (d = t.getBoundingRect(),
    ...
    function l(t, e, i) {
        function n(i, n) {
            ...
            if (v(i, function(e) {
                ...
                s[n])
                return a(e, i[1]) ? d[i[2]] = null : a(e, i[2]) && (d[i[1]] = null),
                    d;
            if (2 !== u && l) {
                if (l >= 2)
                    return r;
    ...
    var m = i(635),
        ...
        D = _();
    e.cubicAt = a,
        e.cubicDerivativeAt = r,
        e.cubicRootAt = s,
        e.cubicExtrema = l,
        e.cubicSubdivide = d,
        e.cubicProjectPoint = u,
        e.quadraticAt = c,
        e.quadraticDerivativeAt = h,
        e.quadraticRootAt = f,
        e.quadraticExtremum = p,
        e.quadraticSubdivide = g,
        e.quadraticProjectPoint = v
}, function(t, e, i) {
    function n(t) {
        this.fromDataset = t.fromDataset,
            this.data = t.data || (t.sourceFormat === p ? {} : []),
    ...
    function n(t, e) {
        w.isInstance(t) || (t = w.seriesDataToSource(t)),
            this._source = t;
    ...
    function d(t, e) {
        ...
        return "time" === i && "number" != typeof t && null != t && "-" !== t && (t = +b(t)),
            null == t || "" === t ? NaN : +t
    }
    ...
    var M = {
        ...
        L = {
            ...
            original: function(t, e, i, n) {
                ...
                return !this._rawData.pure && y(t) && (this.hasItemOption = !0),
                    d(o instanceof Array ? o[n] : o, this._dimensionInfos[e])
            },
            typedArray: function(t, e, i, n) {
                return t[n]
            }
        };
    e.DefaultDataProvider = n,
        e.defaultDimValueGetters = L,
        e.retrieveRawValue = u,
        e.retrieveRawAttr = c
}, function(t, e) {
    ...
    function n(t, e) {
        ...
        if (h = function t(i, a, s) {
                ...
                if (c <= 4)
                    for (var h = 0, f = c; f--;) {
                        var p = +i.charAt(h);
                        d += u && 2 == c && 0 == h && 1 == p ? "" : n.charAt(p),
                            d += p && f ? o.charAt(f) : "",
                            h++
                    }
                else {
                    for (var g = i.length / 4 >> 0, v = i.length % 4; 0 == v || !o.charAt(3 + g);)
                        v += 4,
                        g--;
                    var m = i.substr(0, v),
                        _ = i.substr(v);
    ...
    function o(t) {
        ...
        for (var d = i.split(""), u = 0, c = 0, h = [], f = [], p = [], g = 0; g < d.length; g++) {
            var v = d[g],
                m = 0,
                _ = 0;
            if (~(m = this.ch.indexOf(v)))
                m > 0 && p.unshift(m);
            else if (~(_ = this.ch_u.indexOf(v))) {
                var y = r.getDigit(_);
                u > _ ? (r.unshiftZero(p, y),
                    r.centerArray(f, p)) : _ >= c ? (0 == g && (p = [1]),
                    r.centerArray(h, f, p),
                    h.length > 0 && r.unshiftZero(h, y),
                    c = _) : (0 == p.length && a == v && (p = [1]),
                    r.centerArray(f, p),
                    r.unshiftZero(f, r.getDigit(_)),
                    u = _)
            }
        }
        r.centerArray(h, f, p).reverse(),
            0 == h.length && h.push(0);
        var x = 0;
        if (n) {
            h.push("."),
            ...
            for (var g = 0; g < n.length; g++)
                x += this.ch.indexOf(n.charAt(g)),
                h.push(this.ch.indexOf(n.charAt(g)));
            x = +x
        }
        return o && h.unshift("-"),
            parseFloat(h.join(""))
    ...
    function a(t, e) {
        ...
        var s = o.num,
            ...
            c = "";
        if (e.complete) {
            for (var h = 1; h < this.m_u.length; h++)
                c += n.call(this, l.charAt(h - 1) || "0") + this.m_u.charAt(h);
            u = n.call(this, s, e) + this.m_u.charAt(0)
        } else {
            if (l = r.clearZero(l, "0", "$"))
                for (var f, h = 0; h < this.m_u.length - 1; h++)
                    l.charAt(h) && "0" != l.charAt(h) && (c += n.call(this, l.charAt(h)) + this.m_u.charAt(h + 1),
                        f = !1),
                    "0" !== l.charAt(h) || f || (0 == h && "0" == s || (c += a),
                        f = !0);
    ...
    r.prototype = {
            ...
            remove: function(t) {
                var e = this.__zr,
                    ...
                    o = this._children,
                    a = n.indexOf(o, t);
                return a < 0 ? this : (o.splice(a, 1),
                    t.parent = null,
                    i && (i.delFromStorage(t),
                        t instanceof r && t.delChildrenFromStorage(i)),
                    e && e.refresh(),
                    this)
            },
            removeAll: function() {
    ...
    function n(t, e, n, o, a, r) {
        ...
        var d = {
            ...
            u = s[e].length - 1,
            c = s[e][u];
        return c && c.callAtLast ? s[e].splice(u, 0, d) : s[e].push(d),
            t
    }
        ...
        triggerWithContext: function(t) {
            ...
            if (e) {
                ...
                for (var r = n[n.length - 1], s = e.length, l = 0; l < s;) {
                    var d = e[l];
                    if (i && i.filter && null != d.query && !i.filter(t, d.query))
                        l++;
                    else {
                        switch (a) {
                            case 1:
            ...
            if (t.length) {
                ...
                for (r.each(t, function(t) {
                    ...
                    var h = u.pop(),
                        f = d[h],
                        p = !!c[h];
                    p && (n.call(o, h, f.originalDeps.slice()),
                            delete c[h]),
                        r.each(f.successor, p ? s : a)
                }
                r.each(c, function() {
    ...
    var r = i(630),
        ...
        d = 0;
    e.getUID = n,
        e.enableSubTypeDefaulter = o,
        e.enableTopologicalTravel = a
}, function(t, e) {
    var i = 1;
    "undefined" != typeof window && (i = Math.max(window.devicePixelRatio || 1, 1));
    var n = i;
    e.debugMode = 0,
        e.devicePixelRatio = n
}, function(t, e, i) {
    var n = i(648),
        o = i(635),
        a = i(717),
    ...
    b.prototype = {
            ...
            bezierCurveTo: function(t, e, i, n, o, a) {
                return this.addData(d.C, t, e, i, n, o, a),
            ...
            quadraticCurveTo: function(t, e, i, n) {
                return this.addData(d.Q, t, e, i, n),
            ...
            arc: function(t, e, i, n, o, a) {
                return this.addData(d.A, t, e, i, i, n, o - n, 0, a ? 0 : 1),
            ...
            _dashedLineTo: function(t, e) {
                ...
                for (u /= h,
                    ...
                    a %= o,
                    f -= a * u,
                    v -= a * c; u > 0 && f <= t || u < 0 && f >= t || 0 === u && (c > 0 && v <= e || c < 0 && v >= e);)
                    n = this._dashIdx,
                    i = r[n],
                    f += u * i,
                    v += c * i,
                    this._dashIdx = (n + 1) % m,
                    u > 0 && f < l || u < 0 && f > l || c > 0 && v < d || c < 0 && v > d || s[n % 2 ? "moveTo" : "lineTo"](u >= 0 ? p(f, t) : g(f, t), c >= 0 ? p(v, e) : g(v, e));
                u = f - t,
                    c = v - e,
                    this._dashOffset = -_(u * u + c * c)
            },
            _dashedBezierTo: function(t, e, i, o, a, r) {
                ...
                for (f < 0 && (f = h + f),
                    f %= h,
                    s = 0; s < 1; s += .1)
                    l = y(v, t, i, a, s + .1) - y(v, t, i, a, s),
                    d = y(m, e, o, r, s + .1) - y(m, e, o, r, s),
                    x += _(l * l + d * d);
                for (; b < w && !((S += p[b]) > f); b++)
                ;
                for (s = (S - f) / x; s <= 1;)
                    u = y(v, t, i, a, s),
                    c = y(m, e, o, r, s),
                    b % 2 ? g.moveTo(u, c) : g.lineTo(u, c),
                    s += p[b] / x,
                    b = (b + 1) % w;
                b % 2 != 0 && g.lineTo(a, r),
                    l = a - u,
                    d = r - c,
                    this._dashOffset = -_(l * l + d * d)
            },
            ...
            getBoundingRect: function() {
                u[0] = u[1] = h[0] = h[1] = Number.MAX_VALUE,
                    c[0] = c[1] = f[0] = f[1] = -Number.MAX_VALUE;
                for (var t = this.data, e = 0, i = 0, n = 0, s = 0, l = 0; l < t.length;) {
                    ...
                    switch (1 === l && (e = t[l],
                        ...
                        case d.M:
                            ...
                            break;
                        case d.L:
                            a.fromLine(e, i, t[l], t[l + 1], h, f),
                                e = t[l++],
                                i = t[l++];
                            break;
                        case d.C:
                            a.fromCubic(e, i, t[l++], t[l++], t[l++], t[l++], t[l], t[l + 1], h, f),
                                e = t[l++],
                                i = t[l++];
                            break;
                        case d.Q:
                            a.fromQuadratic(e, i, t[l++], t[l++], t[l], t[l + 1], h, f),
                                e = t[l++],
                                i = t[l++];
                            break;
                        case d.A:
                ...
                return 0 === l && (u[0] = u[1] = c[0] = c[1] = 0),
                    new r(u[0], u[1], c[0] - u[0], c[1] - u[1])
            },
                ...
                for (var e, i, n, o, a, r, s = this.data, l = this._ux, u = this._uy, c = this._len, h = 0; h < c;) {
                    ...
                    switch (1 === h && (n = s[h],
                        ...
                        case d.L:
                            a = s[h++],
                                r = s[h++],
                                (y(a - n) > l || y(r - o) > u || h === c - 1) && (t.lineTo(a, r),
                                    n = a,
                                    o = r);
                            break;
                        case d.C:
                            t.bezierCurveTo(s[h++], s[h++], s[h++], s[h++], s[h++], s[h++]),
                                n = s[h - 2],
                                o = s[h - 1];
                            break;
                        case d.Q:
                            t.quadraticCurveTo(s[h++], s[h++], s[h++], s[h++]),
                                n = s[h - 2],
                                o = s[h - 1];
                            break;
                        case d.A:
                            ...
                            D ? (t.translate(p, g),
                                    ...
                                    t.scale(1 / I, 1 / T),
                                    t.rotate(-S),
                                    t.translate(-p, -g)) : t.arc(p, g, k, b, M, 1 - C),
                                1 === h && (e = v(b) * _ + p,
                                    i = m(b) * x + g),
                                n = v(M) * _ + p,
                                o = m(M) * x + g;
    ...
    function n(t, e, i, n) {
        return i = i || {},
            n || !h.canvasSupported ? o(t, e, i) : h.browser.firefox && null != e.layerX && e.layerX !== e.offsetX ? (i.zrX = e.layerX,
                i.zrY = e.layerY) : null != e.offsetX ? (i.zrX = e.offsetX,
                i.zrY = e.offsetY) : o(t, e, i),
            i
    }
    ...
    function r(t, e, i) {
        ...
        var s = e.button;
        return null == e.which && void 0 !== s && m.test(e.type) && (e.which = 1 & s ? 1 : 2 & s ? 3 : 4 & s ? 2 : 0),
            e
    }
    ...
    e.clientToLocal = n,
        ...
        e.stop = y,
        e.isMiddleOrRightButtonOnMouseUpDown = d,
        e.notLeftMouse = u
}, function(t, e, i) {
    function n(t) {
        t = t || {},
        ...
        if (t) {
            ...
            if ("#" !== n.charAt(0)) {
                ...
                if (-1 !== o && a + 1 === n.length) {
                    ...
                    switch (l) {
                        case "rgba":
                            ...
                            f = s(d.pop());
                        case "rgb":
                            return 3 !== d.length ? void u(e, 0, 0, 0, 1) : (u(e, r(d[0]), r(d[1]), r(d[2]), f),
                                h(t, e),
                                e);
                        case "hsla":
                            return 4 !== d.length ? void u(e, 0, 0, 0, 1) : (d[3] = s(d[3]),
                                p(d, e),
                                h(t, e),
                                e);
                        case "hsl":
                            return 3 !== d.length ? void u(e, 0, 0, 0, 1) : (p(d, e),
                                h(t, e),
                                e);
                        default:
                            return
                ...
                if (4 === n.length) {
                    ...
                    return g >= 0 && g <= 4095 ? (u(e, (3840 & g) >> 4 | (3840 & g) >> 8, 240 & g | (240 & g) >> 4, 15 & g | (15 & g) << 4, 1),
                        h(t, e),
                        e) : void u(e, 0, 0, 0, 1)
                }
                if (7 === n.length) {
                    var g = parseInt(n.substr(1), 16);
                    return g >= 0 && g <= 16777215 ? (u(e, (16711680 & g) >> 16, (65280 & g) >> 8, 255 & g, 1),
                        h(t, e),
                        e) : void u(e, 0, 0, 0, 1)
                }
            }
    ...
    function p(t, e) {
        var i = (parseFloat(t[0]) % 360 + 360) % 360 / 360,
            ...
            d = 2 * a - r;
        return e = e || [],
            u(e, n(255 * l(d, r, i + 1 / 3)), n(255 * l(d, r, i)), n(255 * l(d, r, i - 1 / 3)), 1),
            4 === t.length && (e[3] = t[3]),
            e
    }
        ...
        if (t) {
            ...
            if (0 === l)
                ...
                var u = ((s - n) / 6 + l / 2) / l,
                    c = ((s - o) / 6 + l / 2) / l,
                    h = ((s - a) / 6 + l / 2) / l;
                n === s ? e = h - c : o === s ? e = 1 / 3 + u - h : a === s && (e = 2 / 3 + c - u),
                    e < 0 && (e += 1),
                    e > 1 && (e -= 1)
            }
            var f = [360 * e, i, d];
        ...
        return function() {
            ...
            return new o.default(function(t, i) {
                function n(a, r) {
                    ...
                    if (!s.done)
                        return o.default.resolve(l).then(function(t) {
                            n("next", t)
                        }, function(t) {
                            n("throw", t)
                        });
    ...
    function r(t, e, i, n, o) {
        var a = A[e.type],
            ...
            l = t[s][r];
        if (l && l.length < i) {
            for (var d = new a(Math.min(o - r * i, i)), u = 0; u < l.length; u++)
                d[u] = l[u];
            t[s][r] = d
        }
    ...
    function c(t, e) {
        var i = t._idList[e];
        return null == i && (i = l(t, t._idDimIdx, e)),
            null == i && (i = M + e),
            i
    }

    function h(t) {
        return m.isArray(t) || (t = [t]),
            t
    }
    ...
    function f(t, e) {
        ...
        for (var o = n._storage = {}, r = t._storage, s = 0; s < i.length; s++) {
            var l = i[s];
            r[l] && (m.indexOf(e, l) >= 0 ? (o[l] = p(r[l]),
                n._rawExtent[l] = g(),
                n._extent[l] = null) : o[l] = r[l])
        }
        return n
    }
    ...
    var v = i(634),
        ...
        z = function(t, e) {
            ...
            this.dimensions = n,
                ...
                this._dimensionsSummary = k(this),
    ...
    N.type = "list",
        ...
        N.initData = function(t, e, i) {
            (x.isInstance(t) || m.isArrayLike(t)) && (t = new S(t, this.dimensions.length)),
            this._rawData = t,
                this._storage = {},
                this._indices = null,
                this._nameList = e || [],
                ...
                this.defaultDimValueGetter = w[this._rawData.getSource().sourceFormat],
                this._dimValueGetter = i = i || this.defaultDimValueGetter,
                this._dimValueGetterArrayRows = w.arrayRows,
                this._rawExtent = {},
        ...
        N.appendValues = function(t, e) {
            for (var i = this._chunkSize, n = this._storage, o = this.dimensions, a = o.length, l = this._rawExtent, d = this.count(), u = d + Math.max(t.length, e ? e.length : 0), c = this._chunkCount, h = 0; h < a; h++) {
                ...
                l[f] || (l[f] = g()),
                    n[f] || (n[f] = []),
                    r(n, this._dimensionInfos[f], i, c, u),
                    this._chunkCount = n[f].length
            }
        ...
        N._initDataFromProvider = function(t, e) {
            if (!(t >= e)) {
                for (var i, n = this._chunkSize, o = this._rawData, a = this._storage, l = this.dimensions, d = l.length, u = this._dimensionInfos, c = this._nameList, h = this._idList, f = this._rawExtent, p = this._nameRepeatCount = {}, v = this._chunkCount, m = 0; m < d; m++) {
                    ...
                    f[_] || (f[_] = g());
                    var y = u[_];
                    0 === y.otherDims.itemName && (i = this._nameDimIdx = m),
                        0 === y.otherDims.itemId && (this._idDimIdx = m),
                        a[_] || (a[_] = []),
                        r(a, y, n, v, e),
                        this._chunkCount = a[_].length
                }
        ...
        N.getIndices = function() {
            ...
            if (e) {
                ...
                if (i === Array) {
                    ...
                    t = new i(e.buffer, 0, o)
            } else
                for (var i = n(this), t = new i(this.count()), a = 0; a < t.length; a++)
                    t[a] = a;
            return t
        },
        N.get = function(t, e) {
        ...
        N.each = function(t, e, i, n) {
            ...
            if (this._count) {
                "function" == typeof t && (n = i,
                        ...
                        t = []),
                    i = i || n || this,
                    t = m.map(h(t), this.getDimension, this);
            ...
            if (this._count) {
                ...
                for (var a = this.count(), r = n(this), s = new r(a), l = [], c = t.length, f = 0, p = t[0], g = 0; g < a; g++) {
                    ...
                    if (0 === c)
                        ...
                        for (var x = 0; x < c; x++)
                            l[x] = this._getFast(p, _);
                        l[x] = g,
                            v = e.apply(i, l)
                    }
                    v && (s[f++] = _)
                }
                return f < a && (this._indices = s),
                    this._count = f,
                    this._extent = {},
                    this.getRawIndex = this._indices ? u : d,
                    this
            }
        },
                        ...
                        if (1 === o) {
                            ...
                            for (var v = this._storage[c], w = this._storage[e[1]], S = t[e[1]][0], C = t[e[1]][1], m = 0; m < this._chunkCount; m++)
                                for (var _ = v[m], k = w[m], y = Math.min(this._count - m * this._chunkSize, this._chunkSize), x = 0; x < y; x++) {
                                    var b = _[x],
                                        I = k[x];
                                    (b >= h && b <= f || isNaN(b)) && (I >= S && I <= C || isNaN(I)) && (s[l++] = g),
                                    g++
                                }
                            p = !0
                        }
    ...
    N.setItemGraphicEl = function(t, e) {
        ...
        N.cloneShallow = function(t) {
            ...
            if (t._storage = this._storage,
                ...
                t._indices = null;
            return t.getRawIndex = t._indices ? u : d,
                t
        },
        ...
        N.TRANSFERABLE_METHODS = ["cloneShallow", "downSample", "map"],
        N.CHANGABLE_METHODS = ["filterSelf", "selectRange"];
    var F = z;
    t.exports = F
}, function(t, e, i) {
    function n(t, e) {
        return e = e || {},
            o(e.coordDimensions || [], t, {
    ...
    function n(t, e, i) {
        ...
        if (s(e, function(t, i) {
                l(t) && (e[i] = t = {
                    ...
                    c && !t.isExtraCoord && (d || n || !t.ordinalMeta || (n = t),
                        o || "ordinal" === t.type || "time" === t.type || u && u !== t.coordDim || (o = t))
            }), !o || d || n || (d = !0),
            o) {
            a = "__\0ecstackresult",
                r = "__\0ecstackedover",
    ...
    var r = i(630),
        ...
        l = r.isString;
    e.enableDataStack = n,
        e.isDimensionStacked = o,
        e.getStackedDimension = a
}, function(t, e, i) {
    function n(t) {
        var e = {},
            i = e.encode = {},
        ...
        l(t.dimensions, function(e) {
            ...
            if (d) {
                ...
                o(i, d)[h] = e,
                    l.isExtraCoord || (n.set(d, 1),
                        r(l.type) && (a[0] = e),
                        o(u.encode, d)[h] = l.index),
                    l.defaultTooltip && s.push(e)
            }
            c.each(function(t, e) {
                var n = o(i, e),
                    a = l.otherDims[e];
        ...
        var g = i.tooltip;
        return g && g.length ? s = g.slice() : s.length || (s = a.slice()),
            i.defaultedLabel = a,
    ...
    var s = i(630),
        ...
        u = (s.assert,
            i(634)),
        c = (u.__DEV__,
            d(["tooltip", "label", "itemName", "itemId", "seriesName"]));
    e.OTHER_DIMENSIONS = c,
        e.summarizeDimensions = n,
        e.getDimensionTypeByAxis = a
}, function(t, e, i) {
    function n(t) {
        for (var e = 0; e < t.length; e++)
            t[e][1] || (t[e][1] = t[e][0]);
        ...
        l = a.extend({
            ...
            setInterval: function(t) {
                this._interval = t,
                    ...
                    this._intervalPrecision = r.getIntervalPrecision(t)
            },
            getTicks: function(t) {
                ...
                for (var r = n[0]; r <= n[1] && (a.push(r),
                        (r = s(r + e, o)) !== a[a.length - 1]);)
                    if (a.length > 1e4)
                        return [];
                var l = a.length ? a[a.length - 1] : n[1];
                return i[1] > l && (t ? a.push(s(l + e, o)) : a.push(i[1])),
                    a
            },
            ...
            niceExtent: function(t) {
                ...
                t.fixMin || (e[0] = s(Math.floor(e[0] / o) * o)),
                    t.fixMax || (e[1] = s(Math.ceil(e[1] / o) * o))
            }
        });
    l.create = function() {
        return new l
    ...
    function r(t, e) {
        ...
        var i, n;
        !e && t._reset && (i = t._reset(t.context),
                i && i.progress && (n = i.forceFirstProgress,
                    i = i.progress),
                l(i) && !i.length && (i = null)),
            t._progress = i,
    ...
    u.perform = function(t) {
        ...
        d === c && u === h || (s = "reset");
        var f;
        (this._dirty || "reset" === s) && (this._dirty = !1,
            f = r(this, n)),
        this._modBy = c,
    ...
    (function(e) {
        ...
        ! function(e, o) {
            t.exports = function(o) {
                ...
                return o.Meteor && (Base64 = o.Base64),
                    void 0 !== t && t.exports ? t.exports.Base64 = o.Base64 : (i = [],
                        void 0 !== (n = function() {
                                return o.Base64
                            }
    ...
    ! function(e) {
        ...
        a.prototype = O.constructor = r,
            r.constructor = a,
            r[w] = a.displayName = "GeneratorFunction",
            ...
            f.prototype = {
                ...
                reset: function(t) {
                    if (this.prev = 0,
                        ...
                        for (var e in this)
                            "t" === e.charAt(0) && _.call(this, e) && !isNaN(+e.slice(1)) && (this[e] = v)
                },
                stop: function() {
                    this.done = !0;
    ...
    function l(t, e) {
        ...
        function a(i) {
            ...
            n += f,
                0 != (o -= f) && 0 !== (c = r(t[n + o - 1], t, a, c, c - 1, e)) && (o <= c ? l(n, o, a, c) : d(n, o, a, c))
        }
            ...
            brush: function(t, e) {
                ...
                if (o && s.isImageReady(o)) {
                    var a = i.x || 0,
                        ...
                        d = i.height,
                        u = o.width / o.height;
                    if (null == l && null != d ? l = d * u : null == d && null != l ? d = l / u : null == l && null == d && (l = o.width,
                            d = o.height),
                        this.setTransform(t),
                        i.sWidth && i.sHeight) {
                        var c = i.sx || 0,
    ...
    d.prototype = {
        ...
        bind: function(t, e, i) {
            ...
            if ((r || n.fill !== o.fill) && (t.fillStyle = n.fill),
                (r || n.stroke !== o.stroke) && (t.strokeStyle = n.stroke),
                (r || n.opacity !== o.opacity) && (t.globalAlpha = null == n.opacity ? 1 : n.opacity),
                (r || n.blend !== o.blend) && (t.globalCompositeOperation = n.blend || "source-over"),
                this.hasStroke()) {
                var h = n.lineWidth;
        ...
        getGradient: function(t, e, i) {
            for (var a = "radial" === e.type ? o : n, r = a(t, e, i), s = e.colorStops, l = 0; l < s.length; l++)
    ...
    function o(t, e, i, n, o) {
        if (t) {
            if ("string" == typeof t) {
                ...
                return s ? (e = s.image, !r(e) && s.pending.push(d)) : (e = new Image,
                        e.onload = e.onerror = a,
                        l.put(t, e.__cachedImgObj = {
                            image: e,
                            pending: [d]
                        }),
    ...
    function i(t, e, i) {
        if (e) {
            ...
            t.x1 = n,
                ...
                t.y2 = l;
            var d = i && i.lineWidth;
            d && (a(2 * n) === a(2 * r) && (t.x1 = t.x2 = o(n, d, !0)),
                a(2 * s) === a(2 * l) && (t.y1 = t.y2 = o(s, d, !0)))
        }
    }
    ...
    function n(t, e, i) {
        if (e) {
            ...
            l && (t.x = o(n, l, !0),
                t.y = o(a, l, !0),
                t.width = Math.max(o(n + r, l, !1) - t.x, 0 === r ? 0 : 1),
                t.height = Math.max(o(a + s, l, !1) - t.y, 0 === s ? 0 : 1))
        }
    }
    ...
    var a = Math.round;
    e.subPixelOptimizeLine = i,
        e.subPixelOptimizeRect = n,
    ...
    function n(t, e) {
        ...
        "ordinal" === r ? i = e.getCategories().length : (n = e.get("boundaryGap"),
                g.isArray(n) || (n = [n || 0, n || 0]),
                "boolean" == typeof n[0] && (n = [0, 0]),
                n[0] = y.parsePercent(n[0], 1),
                n[1] = y.parsePercent(n[1], 1),
                a = d[1] - d[0] || Math.abs(d[0])),
            "dataMin" === s ? s = d[0] : "function" == typeof s && (s = s({
                min: d[0],
                max: d[1]
            })),
        ...
        var u = null != s,
            c = null != l;
        null == s && (s = "ordinal" === r ? i ? 0 : NaN : d[0] - n[0] * a),
            null == l && (l = "ordinal" === r ? i ? i - 1 : NaN : d[1] + n[1] * a),
            (null == s || !isFinite(s)) && (s = NaN),
            (null == l || !isFinite(l)) && (l = NaN),
            t.setBlank(g.eqNaN(s) || g.eqNaN(l) || "ordinal" === r && !t.getOrdinalMeta().categories.length),
            e.getNeedCrossZero() && (s > 0 && l > 0 && !u && (s = 0),
                s < 0 && l < 0 && !c && (l = 0));
        var h = e.ecModel;
        if (h && "time" === r) {
            var f, p = b("bar", h);
    ...
    i(817),
        ...
        e.getScaleExtent = n,
        e.niceScaleExtent = a,
        e.createScaleByModel = r,
        e.ifAxisCrossZero = s,
        e.makeLabelFormatter = l,
        e.getAxisRawValue = d,
        e.estimateLabelUnionRect = u,
        e.getOptionCategoryInterval = h,
        e.shouldShowAllLabels = f
}, function(t, e, i) {
    function n(t) {
        null != t && o.extend(this, t),
            this.otherDims = {}
    }
    var o = i(630),
        a = n;
    ...
    function n(t, e, i) {
        function n(t, e, i) {
            null != b.get(e) ? t.otherDims[e] = i : (t.coordDim = e,
                t.coordDimIndex = i,
                v.set(e, !0))
        }
        y.isInstance(e) || (e = y.seriesDataToSource(e)),
            i = i || {},
            t = (t || []).slice();
        for (var r = (i.dimsDef || []).slice(), p = s(), v = s(), x = [], S = o(e, t, r, i.dimCount), C = 0; C < S; C++) {
            var k = r[C] = c({}, h(r[C]) ? r[C] : {
                ...
                I = k.name,
                T = x[C] = new w;
            null != I && null == p.get(I) && (T.name = T.displayName = I,
                    p.set(I, C)),
                null != k.type && (T.type = k.type),
                null != k.displayName && (T.displayName = k.displayName)
        }
        var D = i.encodeDef;
        !D && i.encodeDefaulter && (D = i.encodeDefaulter(e, S)),
            D = s(D),
            D.each(function(t, e) {
                if (t = g(t).slice(),
                    1 === t.length && !d(t[0]) && t[0] < 0)
                    return void D.set(e, !1);
                var i = D.set(e, []);
                l(t, function(t, o) {
                    d(t) && (t = p.get(t)),
                        null != t && t < S && (i[o] = t,
            ...
            if (!1 !== s) {
                ...
                if (!s.length)
                    for (var c = 0; c < (o && o.length || 1); c++) {
                        for (; M < x.length && null != x[M].coordDim;)
                            M++;
                        M < x.length && s.push(M++)
                    }
                l(s, function(e, r) {
        ...
        for (var O = A || "value", R = 0; R < S; R++) {
            var T = x[R] = x[R] || new w;
            null == T.coordDim && (T.coordDim = a(O, v, P),
                    T.coordDimIndex = 0,
                    (!A || L <= 0) && (T.isExtraCoord = !0),
                    L--),
                null == T.name && (T.name = a(T.coordDim, p)),
                null != T.type || m(e, R, T.name) !== _.Must && (!T.isExtraCoord || null == T.otherDims.itemName && null == T.otherDims.seriesName) || (T.type = "ordinal")
        }
        return x
    }
    ...
    function a(t) {
        t = t,
            this.option = {},
            this.option[P] = 1,
            this._componentsMap = y({
                series: []
            }),
            this._seriesIndices,
            this._seriesIndicesMap,
            o(t, this._theme.option),
            w(t, D, !1),
            this.mergeOption(t)
    }
    ...
    var u = i(634),
        ...
        O = I.extend({
            ...
            setOption: function(t, e) {
                x(!(P in t), "please use chart.getOption()"),
            ...
            resetOption: function(t) {
                ...
                if (!t || "recreate" === t) {
                    ...
                    this.option && "recreate" !== t ? (this.restoreData(),
                            this.mergeOption(n)) : a.call(this, n),
                        e = !0
                }
            ...
            mergeOption: function(t) {
                function e(e, o) {
                    ...
                    k.makeIdAndName(d),
                        h(d, function(t, i) {
                            var n = t.option;
                            m(n) && (t.keyInfo.mainType = e,
                                t.keyInfo.subType = s(e, n, t.exist))
                        });
                    var u = r(n, o);
                    i[e] = [],
                        n.set(e, []),
                        h(d, function(t, o) {
                            ...
                            if (x(m(r) || a, "Empty component definition"),
                                ...
                                if (a && a.constructor === s)
                                    ...
                                    a = new s(r, this, this, l),
                                        S(a, l),
                                        a.init(r, this, this, l),
                ...
                L(this),
                    ...
                    T.topologicalTravel(o, T.getAllClassMainTypes(), e, this),
                    this._seriesIndicesMap = y(this._seriesIndices = this._seriesIndices || [])
            },
            getOption: function() {
                var t = b(this.option);
                return h(t, function(e, i) {
                        if (T.hasClass(i)) {
                            for (var e = k.normalizeToArray(e), n = e.length - 1; n >= 0; n--)
                                k.isIdInner(e[n]) && e.splice(n, 1);
                            t[i] = e
                        }
                    }),
                    delete t[P],
    ...
    function n(t, e, i, n) {
        ...
        null != i && u < i && (u = a.interval = i),
            null != n && u > n && (u = a.interval = n);
        var c = a.intervalPrecision = o(u);
        return r(a.niceTickExtent = [l(Math.ceil(t[0] / u) * u, c), l(Math.floor(t[1] / u) * u, c)], t),
            a
    }
    ...
    function r(t, e) {
        !isFinite(t[0]) && (t[0] = e[0]), !isFinite(t[1]) && (t[1] = e[1]),
            a(t, 0, e),
            a(t, 1, e),
            t[0] > t[1] && (t[0] = t[1])
    }
        ...
        h = r.extendShape({
            ...
            buildPath: function(t, e) {
                var i = e.x,
                    ...
                    p = .7 * r;
                t.moveTo(i - u, l + s),
                    t.arc(i, l, r, Math.PI - d, 2 * Math.PI + d),
                    t.bezierCurveTo(i + u - c * f, l + s + h * f, i, n - p, i, n),
                    t.bezierCurveTo(i, n - p, i - u + c * f, l + s + h * f, i - u, l + s),
                    t.closePath()
            }
        }),
        f = r.extendShape({
    ...
    var m = r.extendShape({
        ...
        buildPath: function(t, e, i) {
            ...
            if ("none" !== n) {
                ...
                o || (n = "rect",
                        o = v[n]),
                    g[n](e.x, e.y, e.width, e.height, o.shape),
    ...
    function i(t, e, i) {
        ...
        var h = function() {
            ...
            l = null,
                a = o - (h ? d : u) - t,
                clearTimeout(c),
                h ? c = setTimeout(n, t) : a >= 0 ? n() : c = setTimeout(n, -a),
                d = o
        };
    ...
    function o(t, e, i) {
        if (t && (t.trigger(e, i),
                t.isGroup && !p.isHighDownDispatcher(t)))
            for (var n = 0, a = t.childCount(); n < a; n++)
                o(t.childAt(n), e, i)
    }
    ...
    x.updateView = x.updateLayout = x.updateVisual = function(t, e, i, n) {
        ...
        h.enableClassExtend(n, ["dispose"]),
        h.enableClassManagement(n, {
            registerWhenExtend: !0
        }),
    ...
    s.updateView = s.updateLayout = s.updateVisual = function(t, e, i, n) {},
        a.enableClassExtend(r),
        a.enableClassManagement(r, {
            registerWhenExtend: !0
        });
    var l = r;
    t.exports = l
    ...
    function u(t, e, i, n, o, a, r, s, l) {
        ...
        if (1 === l)
            for (var u = 0; u < d; u++)
                s[u] = c(t[u], e[u], i[u], n[u], o, a, r);
        else
            for (var h = t[0].length, u = 0; u < d; u++)
                for (var f = 0; f < h; f++)
                    s[u][f] = c(t[u][f], e[u][f], i[u][f], n[u][f], o, a, r)
    }
    ...
    function g(t, e, i, n, o, h) {
        ...
        if (b) {
            ...
            if (h || !L) {
                for (var E = M[b - 1], P = 0; P < b - 1; P++)
                    C ? l(M[P], E, T) : !isNaN(M[P]) || isNaN(E) || I || k || (M[P] = E);
                        ...
                        if (0 !== n)
                            if (N = (e - D[i]) / n,
                                ...
                                if (F = M[i],
                                    ...
                                    H = M[i > b - 3 ? b - 1 : i + 2],
                                    C)
                                    u(B, F, V, H, N, N * N, N * N * N, g(t, o), T);
                                else {
                                    var l;
                                    if (k)
                                        l = u(B, F, V, H, N, N * N, N * N * N, U, 1),
                                        l = f(U);
                                    else {
                                        if (I)
                                            return r(F, V, N);
    ...
    d.prototype = {
            ...
            getBoundingRect: function() {
                ...
                if (this.__dirty && r.normalizeTextStyle(t, !0), !this._rect) {
                    ...
                    if (i.x += t.x || 0,
                        i.y += t.y || 0,
                        r.getStroke(t.textStroke, t.textStrokeWidth)) {
    ...
    function i(t, e) {
        ...
        i + n > l && (c = i + n,
            ...
            t.lineTo(r + l, s + d - o),
            0 !== o && t.arc(r + l - o, s + d - o, o, 0, Math.PI / 2),
            t.lineTo(r + a, s + d),
            0 !== a && t.arc(r + a, s + d - a, a, Math.PI / 2, Math.PI),
            t.lineTo(r, s + i),
    ...
    function o(t) {
        if (t) {
            ...
            var e = t.textAlign;
            "middle" === e && (e = "center"),
                t.textAlign = null == e || z[e] ? e : "left";
            var i = t.textVerticalAlign || t.textBaseline;
            "center" === i && (i = "middle"),
                t.textVerticalAlign = null == i || N[i] ? i : "top",
    ...
    function r(t, e, i, n, o, a) {
        ...
        a !== R ? (a && (r = a.style,
                l = !s && u && r),
            e.__attrCachedBy = s ? O.NONE : O.PLAIN_TEXT) : u && (e.__attrCachedBy = O.NONE);
        var f = n.font || E;
        l && f === (r.font || E) || (e.font = f);
        var g = t.__computedFont;
        t.__styleFont !== f && (t.__styleFont = f,
            g = t.__computedFont = e.font);
        var _ = n.textPadding,
            x = n.textLineHeight,
        ...
        var Y = n.textStrokeWidth,
            ...
            K = v(n.textStroke, Y),
            J = m(n.textFill);
        if (K && (Z && (e.lineWidth = Y),
                Q && (e.strokeStyle = K)),
            J && (l && n.textFill === r.textFill || (e.fillStyle = J)),
            1 === S.length)
            K && e.strokeText(S[0], z, N),
            J && e.fillText(S[0], z, N);
        else
            for (var W = 0; W < S.length; W++)
                K && e.strokeText(S[W], z, N),
                J && e.fillText(S[W], z, N),
                N += C
    }
    ...
    function s(t, e, i, n, o, a) {
        ...
        r && !t.__dirtyText || (r = t.__textCotentBlock = D.parseRichText(i, n)),
            l(t, e, r, n, o)
    }
    ...
    function l(t, e, i, n, o) {
        ...
        for (var C = 0; C < i.lines.length; C++) {
            for (var k, I = i.lines[C], T = I.tokens, M = T.length, A = I.lineHeight, L = I.width, P = 0, O = b, R = S, E = M - 1; P < M && (k = T[P], !k.textAlign || "left" === k.textAlign);)
                u(t, e, k, n, A, w, O, "left"),
                L -= k.width,
                O += k.width,
                P++;
            for (; E >= 0 && (k = T[E],
                    "right" === k.textAlign);)
                u(t, e, k, n, A, w, R, "right"),
                L -= k.width,
                R -= k.width,
                E--;
            for (O += (a - (O - b) - (S - R) - L) / 2; P <= E;)
                k = T[P],
                u(t, e, k, n, A, w, O + k.width / 2, "center"),
                O += k.width,
                P++;
            w += A
        }
    ...
    function u(t, e, i, n, o, a, r, s) {
        ...
        var f = i.textPadding;
        f && (r = y(r, s, f),
                u -= i.height / 2 - f[2] - i.textHeight / 2),
            g(e, "shadowBlur", S(l.textShadowBlur, n.textShadowBlur, 0)),
            g(e, "shadowColor", l.textShadowColor || n.textShadowColor || "transparent"),
    ...
    function h(t, e, i, n, o, a, r) {
        var s = i.textBackgroundColor,
            ...
            d = i.textBorderColor,
            u = I(s);
        if (g(e, "shadowBlur", i.textBoxShadowBlur || 0),
            g(e, "shadowColor", i.textBoxShadowColor || "transparent"),
            g(e, "shadowOffsetX", i.textBoxShadowOffsetX || 0),
            g(e, "shadowOffsetY", i.textBoxShadowOffsetY || 0),
            u || l && d) {
            e.beginPath();
    ...
    var n = i(633),
        ...
        s = n.extend({
            ...
            buildPath: function(t, e) {
                var i, n, o, s;
                this.subPixelOptimize ? (a(r, e, this.style),
                    i = r.x1,
                    n = r.y1,
                    o = r.x2,
                    s = r.y2) : (i = e.x1,
    ...
    var n = i(633),
        ...
        l = n.extend({
            ...
            buildPath: function(t, e) {
                var i, n, a, l;
                this.subPixelOptimize ? (r(s, e, this.style),
                        i = s.x,
                        n = s.y,
                        a = s.width,
                        l = s.height,
                        ...
                        a = e.width,
                        l = e.height),
                    e.r ? o.buildPath(t, e) : t.rect(i, n, a, l),
                    t.closePath()
            }
        });
    t.exports = l
    ...
    d.updateTransform = function() {
            ...
            if (!i && !e)
                return void(n && r(n));
            n = n || o.create(),
                i ? this.getLocalTransform(n) : r(n),
                e && (i ? o.mul(n, t.transform, n) : o.copy(n, t.transform)),
                this.transform = n;
    ...
    d.setLocalTransform = function(t) {
        ...
        d.decomposeTransform = function() {
            if (this.transform) {
                var t = this.parent,
                    e = this.transform;
                t && t.transform && (o.mul(c, t.invTransform, e),
                    e = c);
                var i = this.origin;
                i && (i[0] || i[1]) && (h[4] = i[0],
                        h[5] = i[1],
        ...
        d.transformCoordToLocal = function(t, e) {
            var i = [t, e],
                n = this.invTransform;
            return n && a.applyTransform(i, i, n),
                i
        },
    ...
    function o(t) {
        ...
        for (var e, i = 0, o = 0, a = i, r = o, s = new u, l = u.CMD, d = t.match(y), c = 0; c < d.length; c++) {
            for (var h, f = d[c], p = f.charAt(0), g = f.match(x) || [], v = g.length, m = 0; m < v; m++)
                g[m] = parseFloat(g[m]);
            for (var _ = 0; _ < v;) {
                ...
                switch (p) {
                    ...
                    case "C":
                        h = l.C,
                            s.addData(h, g[_++], g[_++], g[_++], g[_++], g[_++], g[_++]),
                            i = g[_ - 2],
                            o = g[_ - 1];
                        break;
                    case "c":
                        h = l.C,
                            s.addData(h, g[_++] + i, g[_++] + o, g[_++] + i, g[_++] + o, g[_++] + i, g[_++] + o),
                            i += g[_ - 2],
                            o += g[_ - 1];
                        break;
                    case "S":
    ...
    function o(t) {
        if (t)
            ...
            for (var e in _)
                _.hasOwnProperty(e) && _[e].dispose();
            _ = {}
        }
        return this
    }
    ...
    var l = i(718),
        ...
        y = function(t, e, i) {
            ...
            this.handler = new c(o, r, s, r.root),
    ...
    i.n(s),
        e.default = {
            ...
            mounted: function() {
                ...
                (i.i(o.f)(t) || t != "broswer_tip_" + this.userId) && (this.exploreTip = !0),
                this.identifyCode = "",
            ...
            created: function() {
                ...
                n.a.getLoginUserInfo({
                    ...
                    200 == e.code && (t.userMssage = e.data,
                        n.a.getUserMessage().then(function(e) {
            ...
            methods: {
                ...
                quitClass: function() {
                    var t = this;
                    this.value.length <= 0 ? this.codeNull = !0 : (this.codeNull = !1,
                        this.value == this.identifyCode ? n.a.tuike({
                            recruitId: this.recruitId
                        }).then(function(e) {
                            0 == e.code && (t.codeErr = !1,
                                t.quitDialog = !1,
                                t.value = "",
                                t.tipsDialog = !0,
                                t.tipsMsg = "您的退课申请提交成功",
                                setTimeout(function() {
                                    window.location.href = "//onlineh5.zhihuishu.com/onlineWeb.html#/studentIndex"
                                }, 2e3))
                        }) : this.codeErr = !0)
                ...
                backSource: function() {
                    ...
                    n.a.queryCanBeTuiKe({
                        ...
                        if (0 == e.code)
                            ...
                            t.tipsDialog = !0,
                                t.tipsMsg = "对不起，您只能在规定的退改选期限内退课！<br/>退改选起止时间：" + n + "~" + a
                        } else
                            t.tipsDialog = !0,
                            t.tipsMsg = "该课程退课，需向本校课程负责老师申请退课"
                    })
                },
            ...
            methods: {
                ...
                drawPic: function() {
                    var t = document.getElementById("s-canvas"),
                        e = t.getContext("2d");
                    e.textBaseline = "middle",
                        e.fillStyle = this.randomColor(180, 240),
                        e.fillRect(0, 0, this.contentWidth, this.contentHeight);
                    for (var i = 0; i < this.identifyCode.length; i++)
                        this.drawText(e, this.identifyCode[i], i);
                    this.drawLine(e),
                        this.drawDot(e)
                },
                drawText: function(t, e, i) {
                    t.fillStyle = this.randomColor(50, 160),
                        t.font = this.randomNum(this.contentHeight / 2, this.contentHeight) + "px SimHei",
                        t.shadowOffsetX = this.randomNum(-3, 3),
                        t.shadowOffsetY = this.randomNum(-3, 3),
                        t.shadowBlur = this.randomNum(-3, 3),
                ...
                drawLine: function(t) {
                    for (var e = 0; e < 4; e++)
                        t.strokeStyle = this.randomColor(40, 180),
                        t.beginPath(),
                ...
                drawDot: function(t) {
                    for (var e = 0; e < this.contentWidth / 4; e++)
        ...
        mounted: function() {
            ...
            document.title = "课程学习_智慧树",
                ...
                window.onbeforeunload = function() {
                    t.goBack(),
                        t.data.hasHabbitScore && (i.i(p.d)("habitTimeKey", 0),
                            clearInterval(t.habitTimer))
                }
        },
        created: function() {
            this.recruitAndCourseId = this.$route.query.recruitAndCourseId,
                this.getqueryCourse(),
                this.getVideoList()
        },
        methods: {
            ...
            habitWarn: function() {
                ...
                !this.data.hasHabbitScore || "false" != e && e || (this.habitTime = i.i(p.a)("habitTimeKey") ? i.i(p.a)("habitTimeKey") : 0,
                    this.habitTimer = setInterval(function() {
            ...
            lookHabitBtn: function() {
                this.lookHabitDialog = !1,
                    this.learnHabitDialog = !0
            },
            heightCompute: function() {
                ...
                i.i(p.f)(o) || o != "broswer_tip_" + a ? (e.style.height = n - 113 + "px",
                    t.style.height = n - 313 + "px") : (e.style.height = n - 60 + "px",
                    t.style.height = n - 260 + "px")
            },
            goBack: function() {
                var t = this.lessonId,
            ...
            aberrantBtn: function() {
                this.aberrantDialog = !1,
                    window.open("https://onlineh5.zhihuishu.com/subPage.html#/student/exceptionRecordList")
            },
            ...
            aberrantFun: function() {
                ...
                m.a.eADetail({
                    ...
                    0 == e.code ? (t.aberrantInfo = e.data,
                        e.data.popWindow ? (t.aberrantDialog = !0,
                            ablePlayerX("container").pause()) : e.data.lock && (t.aberrantTimeDialog = !0,
                            ablePlayerX("container").pause())) : 403 == e.code && setTimeout(function() {
                        window.location.href = root + "/login/gologin?fromurl=" + encodeURIComponent(window.location.href)
                    }, 3e3)
                })
            },
            ...
            warnClick: function() {
                i.i(p.d)("warnKey", "warn_" + JSON.parse(i.i(p.a)("CASLOGC")).userId),
                    this.warnDialog = !1
            },
            startShowRead: function() {
                var t = i.i(p.a)("readKey"),
                    e = "read_" + this.recruitId;
                (i.i(p.f)(t) || e != t) && (this.readDialog = !0,
                    this.studyBefore())
            },
            readCloseClick: function() {
                i.i(p.d)("readKey", "read_" + this.recruitId),
                    this.readDialog = !1
            },
            readClick: function() {
                this.readDialog = !0,
            ...
            studyBefore: function() {
                ...
                m.a.queryStudyReadBefore({
                    ...
                    0 == e.code ? (t.readInfo = e.data,
                        t.studentLearnchart(t.readInfo.scoreAssessRule.usualScoreShare, t.readInfo.scoreAssessRule.examScoreShare, t.readInfo.scoreAssessRule.meetCourseScoreShare, t.readInfo.scoreAssessRule.finalExamScoreShare)) : 403 == e.code && setTimeout(function() {
                        window.location.href = root + "/login/gologin?fromurl=" + encodeURIComponent(window.location.href)
                    }, 3e3)
                })
            },
            classClick: function() {
                this.queryUserClassInfo(),
                    this.classDialog = !0
            },
            isBlackFun: function() {
                this.isBlack = !this.isBlack,
                    i.i(p.d)("blackToWhiteKey", "black_white_" + JSON.parse(i.i(p.a)("CASLOGC")).userId),
                    i.i(p.d)("blackToWhiteKey2", this.isBlack)
            },
            ...
            videoClick: function(t, e, i, n, o, a) {
                var r = this;
                if (this.watchPointPost = "",
                    this.unPlayCount = 0,
                    this.showVideo = !0,
                    this.showThree = !1,
                    1 == this.videoData.type)
                    if (this.limitInfo.studyTimeDto.canBeStudyNow)
                        if (t.id == this.videoDetail.id)
                            1 != this.data.studyStatus && (this.saveDataFilish = !0,
                                this.clearTimer(),
                                this.saveDatabaseIntervalTime(t, i, o)),
                            this.saveDataFilish || this.prelearningNote(t, i, o);
                        else {
                            for (var s = 0; s < e; s++)
                                this.videoList[s].videoLessons && this.videoList[s].videoLessons.map(function(t) {
                            ...
                            if (!this.videoData.canJumpChapter && this.unPlayCount)
                ...
                else if (t.id == this.videoDetail.id)
                    1 != this.data.studyStatus && (this.saveDataFilish = !0,
                        this.clearTimer(),
                        this.saveDatabaseIntervalTime(t, i, o)),
                    this.saveDataFilish || this.prelearningNote(t, i, o);
                    ...
                    for (var l = 0; l < e; l++)
                        this.videoList[l].videoLessons && this.videoList[l].videoLessons.map(function(t) {
                            t.ishaveChildrenLesson > 0 && t.videoSmallLessons && t.videoSmallLessons.length > 0 ? t.videoSmallLessons.map(function(t) {
                                (0 === t.isStudiedLesson || 2 === t.isStudiedLesson && t.percentage <= 80) && (r.unPlayCount += 1)
                            }) : (0 === t.isStudiedLesson || 2 === t.isStudiedLesson && t.percentage <= 80) && (r.unPlayCount += 1)
                        });
                    1 != this.data.studyStatus && (this.saveDataFilish = !0,
                            this.clearTimer(),
                            this.saveDatabaseIntervalTime(t, i, o)),
                        this.videoData.canJumpChapter || !this.unPlayCount ? this.saveDataFilish || this.prelearningNote(t, i, o) : this.$message({
                            message: "本课程不能跨章学习,本章之前还有" + this.unPlayCount + "个视频没有看完"
                        })
                }
            },
            getVideoList: function() {
                ...
                m.a.getVideoList({
                    ...
                    0 == e.code ? (e.data.videoChapterDtos.map(function(t) {
                        ...
                        t.recruitId = e.data.recruitId,
                        t.videoList = e.data.videoChapterDtos,
                        t.headerShow = !0,
                        t.videoList && t.videoList.map(function(e, n) {
                            e.orderNumberTit = w.a.encodeS(e.orderNumber),
                                e.videoLessons && e.videoLessons.map(function(e, n) {
                                    t.lessonIds.push(e.id),
                                        e.videoId && t.videoIds.push(e.videoId),
                                        e.videoSecShow = i.i(p.g)(e.videoSec),
                                        e.ishaveChildrenLesson > 0 && e.videoSmallLessons && e.videoSmallLessons.length > 0 && e.videoSmallLessons.map(function(e, n) {
                                            t.lessonVideoIds.push(e.id),
                                                t.videoIds.push(e.videoId),
                                                e.name = e.name ? e.name : "暂无小节名称",
                                                e.videoSecShow = i.i(p.g)(e.videoSec)
                                        })
                                })
                        }),
                        t.queryStuyInfo(),
                        t.getLastVideoId()) : -2 == e.code ? (t.$message({
            ...
            getqueryCourse: function() {
                ...
                i.i(p.f)(e) || (e = JSON.parse(e),
                        e.userId == n && (delete e.userId,
                            m.a.saveDatabaseIntervalTime(e).then(function(e) {
                                t.playTimes = 0, -10 == e.code ? (t.tipsDialog = !0,
                                    t.tipsMsg = "同时播放多个视频，其他页面的学习进度将停止记录哦！",
                                    t.tipsBtn = "我知道了") : 403 == e.code ? setTimeout(function() {
                                    window.location.href = root + "/login/gologin?fromurl=" + encodeURIComponent(window.location.href)
                                }, 3e3) : t.saveDataFilish && item && (t.prelearningNote(item, itemChild, itemSon),
                                    t.saveDataFilish = !1)
                            }))),
                    m.a.queryCourse({
                        recruitAndCourseId: this.$route.query.recruitAndCourseId
                    }).then(function(e) {
                        0 == e.code ? (t.data = e.data,
                            t.habitWarn(),
                            t.videoData = e.data.courseInfo || {},
                            t.courseId = t.videoData.courseId,
                            t.courseIdNum = t.videoData.courseId ? Number(t.videoData.courseId) : 0,
                            t.recruitId = e.data.recruitId,
                            t.schoolId = e.data.schoolId ? e.data.schoolId : 0,
                            t.classId = e.data.classId ? e.data.classId : "-1",
                            t.blackChangeWhite(),
                            t.startShowWarn(),
                            t.startShowRead(),
                            t.queryCourseDispMode(),
                            1 == e.data.studyStatus ? (t.tipsDialog = !0,
                                t.tipsMsg = "学习时间已经结束, 观看视频将不再计进度 请知晓",
                                t.tipsBtn = "我知道了") : t.schoolId && t.aberrantFun()) : -3 == e.code ? t.$message({
                            message: e.message,
                            customClass: "error",
                            iconClass: "iconfont zhihuishu-icon_toast_cross"
            ...
            queryStuyInfo: function() {
                ...
                this.lessonVideoIds.length <= 0 && delete e.lessonVideoIds,
                    m.a.queryStuyInfo(e).then(function(e) {
                        0 == e.code ? t.videoList && t.videoList.map(function(t, i) {
                            t.videoLessons && t.videoLessons.map(function(t, i) {
                                if (t.ishaveChildrenLesson > 0 && t.videoSmallLessons && t.videoSmallLessons.length > 0)
                                    t.videoSmallLessons.map(function(t, i) {
                                        if (l()(e.data.lv).forEach(function(i) {
                                                t.id == i && (t.isStudiedLesson = e.data.lv[i].watchState,
                                                    t.studyTotalTime = e.data.lv[i].studyTotalTime)
                                            }),
                                            2 == t.isStudiedLesson) {
                                            var n = Math.floor(t.studyTotalTime / t.videoSec * 100);
                                            n = n >= 100 ? 100 : n,
                                                t.percentage = 0 == n ? 0 : n
                                        }
                                    });
                                else if (l()(e.data.lesson).forEach(function(i) {
                                        t.id == i && (t.isStudiedLesson = e.data.lesson[i].watchState,
                                            t.studyTotalTime = e.data.lesson[i].studyTotalTime)
                                    }),
                                    2 == t.isStudiedLesson) {
                                    var n = Math.floor(t.studyTotalTime / t.videoSec * 100);
                                    n = n >= 100 ? 100 : n,
            ...
            getLastVideoId: function() {
                ...
                m.a.queryUserRecruitIdLastVideoId({
                    ...
                    0 == e.code ? (e.data.lastViewVideoId && -1 != t.videoIds.indexOf(e.data.lastViewVideoId) ? t.lastViewVideoId = e.data.lastViewVideoId : t.videoList[0].videoLessons[0].ishaveChildrenLesson > 0 && t.videoList[0].videoLessons[0].videoSmallLessons && t.videoList[0].videoLessons[0].videoSmallLessons.length > 0 ? t.lastViewVideoId = t.videoList[0].videoLessons[0].videoSmallLessons[0].videoId : t.lastViewVideoId = t.videoList[0].videoLessons[0].videoId,
                        t.limitStudy()) : 403 == e.code && setTimeout(function() {
                        window.location.href = root + "/login/gologin?fromurl=" + encodeURIComponent(window.location.href)
                    }, 3e3)
                })
            },
                    ...
                    return o.a.wrap(function(t) {
                        for (;;)
                            switch (t.prev = t.next) {
                                case 0:
                                    return t.next = 2,
                                        m.a.queryCourseDispMode({
                                            recruitAndCourseId: e.$route.query.recruitAndCourseId
                                        });
                                case 2:
                                    i = t.sent,
                                        0 == i.code && i.data && (e.chapterDisplayMode = i.data + "");
                                case 4:
                                case "end":
                                    return t.stop()
                            }
            ...
            chapeterDataFun: function(t, e, i) {
                this.videoDetail.chapterId = e.chapterId,
                    this.videoDetail.chapterNum = t.orderNumberTit,
                    this.videoDetail.id = t.id,
                    this.videoDetail.chaNum = t.orderNumber,
                    this.videoDetail.num = e.orderNumber,
                    this.videoDetail.sonNum = i ? i.orderNumber : "",
                    this.videoDetail.name = i ? i.name : e.name,
                    this.lessonId = e.id,
                    this.videoTime = i ? i.videoSec : e.videoSec,
                    this.lessonId = e.id,
                    this.smallLessonId = i && i.id ? i.id : 0
            },
            prelearningNote: function(t, e, i) {
                var n = this;
                this.totalStudyTime = 0,
                    this.totalTimeFinish = 0,
                    this.lastViewVideoId = i ? i.videoId : e.videoId,
                    this.chapeterDataFun(t, e, i);
                var o = {
                ...
                0 === o.lessonVideoId && delete o.lessonVideoId,
                    m.a.prelearningNote(o).then(function(t) {
                        if (0 == t.code) {
                            n.preVideoInfo = t.data;
                            var o = n.preVideoInfo.studiedLessonDto.learnTimeSec ? n.preVideoInfo.studiedLessonDto.learnTimeSec : 0;
                            n.aberrantDialog || n.aberrantTimeDialog || (i ? 0 === i.videoSec ? (n.tipsDialog = !0,
                                    n.tipsMsg = "视频正在转码中，换个时间再来看看吧！",
                                    n.tipsBtn = "确定") : n.initVideo(o) : 0 === e.videoSec ? (n.tipsDialog = !0,
                                    n.tipsMsg = "视频正在转码中，换个时间再来看看吧！",
                                    n.tipsBtn = "确定") : n.initVideo(o),
                                n.totalStudyTime += n.preVideoInfo.studiedLessonDto.studyTotalTime,
                                n.totalTimeFinish = n.preVideoInfo.studiedLessonDto.learnTimeSec)
                        } else
            ...
            computeProgree: function() {
                ...
                this.videoList.map(function(e, i) {
                    e.videoLessons && e.videoLessons.map(function(e, i) {
                        if (e.ishaveChildrenLesson > 0 && e.videoSmallLessons && e.videoSmallLessons.length > 0)
                            e.videoSmallLessons.map(function(e, i) {
                                if (t.lastViewVideoId == e.videoId && (0 === e.isStudiedLesson && (e.isStudiedLesson = 2),
                                        2 === e.isStudiedLesson && t.totalStudyTime >= e.studyTotalTime)) {
                                    var n = parseInt(t.totalStudyTime / e.videoSec * 100);
                                    n = n >= 100 ? 100 : n,
                                        e.percentage = 0 == n ? 0 : n,
                                        e.percentage >= 80 && (e.isStudiedLesson = 1,
                                            t.saveDatabaseIntervalTime())
                                }
                            });
                        else if (t.lastViewVideoId == e.videoId && (0 === e.isStudiedLesson && (e.isStudiedLesson = 2),
                                2 === e.isStudiedLesson && t.totalStudyTime >= e.studyTotalTime)) {
                            var n = parseInt(t.totalStudyTime / e.videoSec * 100);
                            n = n >= 100 ? 100 : n,
                                e.percentage = 0 == n ? 0 : n,
            ...
            limitStudy: function() {
                ...
                1 == this.videoData.type ? m.a.queryStudiedTimeLimitInfo({
                    ...
                    0 == e.code ? (t.limitInfo = e.data,
                        t.limitInfo.studyTimeDto.canBeStudyNow || t.aberrantTimeDialog ? t.limitStudyFun() : (t.showVideo = !1,
                            t.limitInfo.studyTimeDto.studyTimeDetials && t.limitInfo.studyTimeDto.studyTimeDetials.map(function(t) {
            ...
            limitStudyFun: function() {
                ...
                this.videoList && this.videoList.map(function(e, i) {
                    e.orderNumberTit = w.a.encodeS(e.orderNumber),
                        e.videoLessons && e.videoLessons.map(function(i, n) {
            ...
            outline: function() {
                ...
                m.a.outline({
                    ...
                    0 == e.code ? (t.teachInfo = e.data,
                        t.teachInfo.courseOutlineInfo.chapterList.map(function(t) {
            ...
            getThreeD: function() {
                ...
                m.a.threeDimens({
                    ...
                    0 == e.code ? (t.showThree = !0,
                        e.data.fileAttachmentAppDtos && e.data.fileAttachmentAppDtos.map(function(t) {
                            t.showThreeD = !1,
                                t.showThreeDCss = !1
                        }),
            ...
            popupAnswer: function() {
                ...
                this.smallLessonId || delete e.lessonVideoId,
                    m.a.popupAnswer(e).then(function(e) {
                        if (0 == e.code) {
                            e.data.listTotal = [];
                            var i = [];
                            e.data.questionPoint && e.data.questionPoint.length > 0 && e.data.questionPoint.map(function(e) {
                                    e.showDot = !1,
                                        e.positionLeft = e.timeSec / t.videoTime * 100,
                                        e.positionTop = 0,
                                        e.testType = 1,
                                        i.push(e)
                                }),
                            ...
                            for (var n = 0; n < i.length; n++)
                                for (var o = i.length - 1; o > 0; o--)
                                    i[n].positionLeft == i[o].positionLeft && (i[o].positionLeft += .5);
                            e.data.listTotal = i,
                                t.testInfo = e.data
                        } else
                            403 == e.code && setTimeout(function() {
            ...
            testDotClick: function(t) {
                ...
                this.smallLessonId || delete n.lessonVideoId,
                    1 == t.testType ? m.a.lessonPopupExam(n).then(function(t) {
                        ablePlayerX("container").pause(),
                            0 == t.code ? t.data.lessonTestQuestionUseInterfaceDtos && (t.data.lessonTestQuestionUseInterfaceDtos.map(function(t) {
                                    t.imagList = t.datas && t.datas.filter(function(t) {
                                        ...
                                        t.answerRight = [],
                                        t.isError = null,
                                        t.zAnswer ? (t.showAnswer = !0,
                                            t.isCheck = !0,
                                            t.answerStu = t.zAnswer.answer.split(",")) : (t.showAnswer = !1,
                                            t.isCheck = !1,
                                            t.answerStu = []),
                                        t.testQuestion.questionOptions.map(function(e) {
                                            e.sortUs = i.i(p.h)(e.sort),
                                                e.isClick = !1,
                                                t.zAnswer && t.answerStu.map(function(t) {
                                                    e.id == t && (e.isClick = !0)
                                                }),
                                                1 == e.result && (t.answerRight.push(e.id),
                                                    t.answerUs.push(e.sortUs))
                                        }),
                                        t.answerRight.join(",") === t.answerStu.join(",") ? t.isError = !1 : t.isError = !0
                                }),
                                e.topicInfo = t.data,
                                e.pageList = e.topicInfo.lessonTestQuestionUseInterfaceDtos[0],
                                e.testDialog = !0,
                                i.i(p.d)("habitTimeKey", "" + e.habitTime),
                                clearInterval(e.habitTimer)) : 403 == t.code && setTimeout(function() {
                                window.location.href = root + "/login/gologin?fromurl=" + encodeURIComponent(window.location.href)
                            }, 3e3)
                    }) : 2 == t.testType ? (ablePlayerX("container").pause(),
                        this.imgUrlDialog = t.url,
                        this.imgDialog = !0,
                        i.i(p.d)("habitTimeKey", "" + this.habitTime),
                        clearInterval(this.habitTimer)) : 3 == t.testType ? t.visible = !t.visible : 4 == t.testType && (t.visible = !t.visible)
            },
            closeImg: function() {
                this.imgDialog = !1,
                    this.habitWarn()
            ...
            autoTestFun: function(t) {
                ...
                this.testInfo.listTotal && this.testInfo.listTotal.length > 0 && this.testInfo.listTotal.map(function(i, n) {
                    if ((1 == i.testType || 2 == i.testType) && parseInt(t) == i.timeSec)
                        return ablePlayerX("container").exitFullPlay(),
                            i.timeSec = i.timeSec - 1,
                            void e.testDotClick(i)
                })
            },
            pageeClick: function(t) {
                var e = this;
                this.showTialogVideo = !1,
                    this.pageList = this.topicInfo.lessonTestQuestionUseInterfaceDtos[t - 1],
                    setTimeout(function() {
                        e.showTialogVideo = !0
                    }, 100)
            },
            topicClick: function(t) {
                ...
                this.topicInfo.lessonTestQuestionUseInterfaceDtos.map(function(i) {
                        if (i.answerStu = [],
                            i.testQuestion.questionId == e.pageList.testQuestion.questionId) {
                            if (i.isCheck = !0,
                                "radio" == i.testQuestion.questionType.inputType)
                                i.testQuestion.questionOptions.map(function(e) {
                                    e.isClick = !1,
                                        t.id == e.id && i.answerStu.push(t.id)
                                }),
                                t.isClick = !0;
                            ...
                            for (var o = !0, a = 0; a < i.answerStu.length; a++)
                                -
                                1 == i.answerRight.indexOf(i.answerStu[a]) && (o = !1);
                            o ? i.answerStu.join(",") == i.answerRight.join(",") ? (i.isError = !1,
                                    i.showAnswer = !0) : (i.isError = null,
                                    i.showAnswer = !1) : (i.isError = !0,
                                    i.showAnswer = !0),
                                e.answerStu = i.answerStu
                        }
                    }),
                    i = {
                        courseId: this.courseId,
                    ...
                    0 === i.lessonVideoId && delete i.lessonVideoId,
                    m.a.saveLessonPopupExamSaveAnswer(i).then(function(t) {
                        403 == t.code && setTimeout(function() {
                            window.location.href = root + "/login/gologin?fromurl=" + encodeURIComponent(window.location.href)
                        }, 3e3)
                    })
            ...
            imagePreClick: function(t, e) {
                this.swiperVisible = !0,
                    this.initIndex = e,
                    this.swiperCurrNum = e + 1
            },
            ...
            videoNext: function() {
                var t = this;
                ablePlayerX("container").exitFullPlay(),
                    this.videoList && this.videoList.map(function(e, i) {
                        e.videoLessons && e.videoLessons.map(function(n, o) {
                            if (n.ishaveChildrenLesson > 0 && n.videoSmallLessons && n.videoSmallLessons.length > 0)
                                n.videoSmallLessons.map(function(a, r) {
                                    if (t.lastViewVideoId === a.videoId)
                                        if (r == n.videoSmallLessons.length - 1)
                                            if (o == e.videoLessons.length - 1) {
                                                if (i == t.videoList.length - 1)
                                                    return;
                                                ...
                                                e.videoLessons[o + 1].ishaveChildrenLesson > 0 && e.videoLessons[o + 1].videoSmallLessons && e.videoLessons[o + 1].videoSmallLessons.length > 0 ? t.videoClick(e, i + 1, e.videoLessons[o + 1], o + 1, e.videoLessons[o + 1].videoSmallLessons[0], 0) : t.videoClick(e, i, e.videoLessons[o + 1], o + 1);
                                    else
                                        t.videoClick(e, i, n, o, n.videoSmallLessons[r + 1], r + 1)
                                });
                                ...
                                if (o == e.videoLessons.length - 1) {
                                    ...
                                    t.videoClick(e, i, e.videoLessons[o + 1], o + 1)
                        })
                    })
            },
            initVideo: function(t) {
                ...
                $("#container").Ableplayer({
                    ...
                    onPause: function() {
                        console.log("暂停"),
                            1 != e.data.studyStatus && (e.clearTimer(),
                                e.saveDatabaseIntervalTime())
                    },
                    onPlay: function() {
                        console.log("播放"),
                            i.i(p.f)(e.totalStudyTimeInterval) && 1 != e.data.studyStatus && e.startTotalTimer()
                    },
                    onTime: function(t) {
                        e.threeDFun(t),
                            e.autoTestFun(t)
            ...
            clearTimer: function() {
                clearInterval(this.learningTimeRecordInterval),
                    clearInterval(this.totalStudyTimeInterval),
                    clearInterval(this.cacheInterval),
                    clearInterval(this.databaseInterval),
                    this.totalStudyTimeInterval = null,
                    this.cacheInterval = null,
                    this.databaseInterval = null,
                    this.learningTimeRecordInterval = null
            },
            ...
            saveCacheIntervalTime: function() {
                ...
                console.log("提交进度时间:" + this.playTimes),
                    ...
                    m.a.saveCacheIntervalTime(n).then(function(e) {
                        t.playTimes = 0,
                            t.watchPointPost = "", -10 == e.code ? (t.tipsDialog = !0,
                                t.tipsMsg = "同时播放多个视频，其他页面的学习进度将停止记录哦！",
                                t.tipsBtn = "我知道了") : 0 != e.code && (t.backDialog = !0)
                    })
            },
            saveDatabaseIntervalTime: function(t, e, n) {
                ...
                console.log("提交进度时间:" + this.playTimes),
                    ...
                    m.a.saveDatabaseIntervalTime(l).then(function(i) {
                        o.playTimes = 0,
                            o.watchPointPost = "", -10 == i.code ? (o.tipsDialog = !0,
            ...
            chapterExamEntry: function(t) {
                ...
                m.a.queryStudentIsLimitFlow({}).then(function(i) {
                    200 == i.status && i.rt.isOpen ? (e.waitTime = i.rt.time ? i.rt.time : 0,
                        e.limitEntryDialog()) : e.judgeLookAnswer(t)
                })
            },
            judgeLookAnswer: function(t) {
                var e = this,
                    i = "";
                if (this.lookAnswerInfo = t.studentExamDto,
                    1 == this.data.studyStatus || !t.studentExamDto.id)
                    return this.goToExamListUrl(), !1;
                m.a.findExamCorrectType({
                    ...
                    3 !== t.studentExamDto.state && 4 !== t.studentExamDto.state ? (i = this.isHuPing ? "https://exam.zhihuishu.com/onlineExam/studentExam/stuExam?recruitId=" + this.recruitId : t.studentExamDto.examUrl,
                        window.open(i)) : 3 == t.studentExamDto.state ? (this.tipsDialog = !0,
                        this.tipsMsg = "作业已上交，不可查看",
                        this.tipsBtn = "我知道了") : 4 == t.studentExamDto.state && m.a.isCheckAnswer({
                        studentExamId: t.studentExamDto.id
                    }).then(function(n) {
                        0 == n.code ? n.data.checkAnswer ? (i = e.isHuPing ? "https://exam.zhihuishu.com/onlineExam/studentExam/stuExam?recruitId=" + e.recruitId : t.studentExamDto.examUrl,
                            window.open(i)) : e.lookAnswerDialog = !0 : 403 == n.code && setTimeout(function() {
                            window.location.href = root + "/login/gologin?fromurl=" + encodeURIComponent(window.location.href)
                        }, 3e3)
                    })
            },
            lookAnsSureBtn: function() {
                ...
                m.a.updateCheckAnswer({
                    ...
                    0 == i.code ? (e = t.isHuPing ? "https://exam.zhihuishu.com/onlineExam/studentExam/stuExam?recruitId=" + t.recruitId : t.lookAnswerInfo.examUrl,
                        t.lookAnswerDialog = !1,
                        window.open(e)) : 403 == i.code && setTimeout(function() {
                        window.location.href = root + "/login/gologin?fromurl=" + encodeURIComponent(window.location.href)
                    }, 3e3)
                })
            },
            ...
            goToExamJudge: function() {
                ...
                m.a.queryStudentIsLimitFlow({}).then(function(e) {
                    200 == e.status && e.rt.isOpen ? (t.waitTime = e.rt.time ? e.rt.time : 0,
                        t.limitEntryDialog()) : t.goToExamListUrl()
                })
            },
            limitEntryDialog: function() {
                var t = this.waitTime;
                return this.tipsDialog = !0,
                    this.tipsMsg = "目前为作业考试高峰期，请错开时间，" + t + "分钟后再来~",
                    this.tipsBtn = "我知道了", !1
            }
        }
    }
    ...
    function n(t, e, i) {
        i = i || {},
            _.isInstance(t) || (t = _.seriesDataToSource(t));
        ...
        g = n.extendSeriesModel({
            ...
            init: function(t) {
                g.superApply(this, "init", arguments),
                    this.legendVisualProvider = new p(a.bind(this.getData, this), a.bind(this.getRawData, this)),
            ...
            getDataParams: function(t) {
                ...
                return e.each(e.mapDimension("value"), function(t) {
                    ...
                    i.percent = l(n, t, e.hostModel.get("percentPrecision")),
                    i.$vars.push("percent"),
                    i
            },
    ...
    d.updateData = function(t, e, i) {
            ...
            i ? (n.setShape(h),
                "scale" === d.getShallow("animationType") ? (n.shape.r = c.r0,
                    s.initProps(n, {
                        shape: {
                            r: c.r
                        }
                    }, d, e)) : (n.shape.endAngle = c.startAngle,
                    s.updateProps(n, {
                        shape: {
                            endAngle: c.endAngle
                        }
            ...
            g && n.attr("cursor", g),
                o(this, t.getItemLayout(e), d.isSelected(t.getName(e)), d.get("selectedOffset"), d.get("animation"));
            var v = !i && "transition" === f;
            this._updateLabel(t, e, v),
                this.highDownOnUpdate = d.get("silent") ? null : function(t, e) {
                    var i = d.isAnimationEnabled() && u.get("hoverAnimation");
                    "emphasis" === e ? (a.ignore = a.hoverIgnore,
                        ...
                        i && (n.stopAnimation(!0),
                            ...
                            }, 300, "elasticOut"))) : (a.ignore = a.normalIgnore,
        ...
        d._updateLabel = function(t, e, i) {
            ...
            if (!d || isNaN(d.x) || isNaN(d.y))
                return void(o.ignore = o.normalIgnore = o.hoverIgnore = n.ignore = n.normalIgnore = n.hoverIgnore = !0);
            var c = {
                    points: d.linePoints || [
                        [d.x, d.y],
                        [d.x, d.y],
            ...
            s.setLabelStyle(o.style, o.hoverStyle = {}, f, p, {
                ...
                o.ignore = o.normalIgnore = !f.get("show"),
                o.hoverIgnore = !p.get("show"),
                n.ignore = n.normalIgnore = !g.get("show"),
                n.hoverIgnore = !v.get("show"),
                n.setStyle({
                    stroke: u,
                    opacity: t.getItemVisual(e, "opacity")
                }),
                n.setStyle(g.getModel("lineStyle").getLineStyle()),
                n.hoverStyle = v.getModel("lineStyle").getLineStyle();
            var m = g.get("smooth");
            m && !0 === m && (m = .4),
                n.setShape({
                    smooth: m
            ...
            render: function(t, e, i, o) {
                if (!o || o.from !== this.uid) {
                    ...
                    if (s.diff(l).add(function(t) {
                        ...
                        u && s.count() > 0 && (c ? "scale" !== h : "transition" !== f)) {
                        for (var v = s.getItemLayout(0), m = 1; isNaN(v.startAngle) && m < s.count(); ++m)
                            v = s.getItemLayout(m);
    ...
    function n(t, e, i, n, o, a, r, s, l, d) {
        ...
        for (var h, f = 0, p = t.length, g = [], v = [], m = 0; m < p; m++) {
            if ("outer" === t[m].position && "labelLine" === t[m].labelAlignTo) {
                var _ = t[m].x - d;
                t[m].linePoints[1][0] += _,
                    t[m].x = d
            }
            h = t[m].y - f,
                h < 0 && function(e, i, n, o) {
        ...
        r - f < 0 && u(p - 1, f - r);
        for (var m = 0; m < p; m++)
            t[m].y >= i ? v.push(t[m]) : g.push(t[m]);
        c(g, !1, e, i, n, o),
            c(v, !0, e, i, n, o)
    }

    function o(t, e, i, o, r, l, d, u) {
        for (var c = [], h = [], f = Number.MAX_VALUE, p = -Number.MAX_VALUE, g = 0; g < t.length; g++)
            a(t[g]) || (t[g].x < e ? (f = Math.min(f, t[g].x),
                c.push(t[g])) : (p = Math.max(p, t[g].x),
                h.push(t[g])));
        n(h, e, i, o, 1, r, l, d, u, p),
            n(c, e, i, o, -1, r, l, d, u, f);
            ...
            if (!a(v)) {
                ...
                if (m) {
                    var _, y = "edge" === v.labelAlignTo,
                        x = v.textRect.width;
                    (_ = y ? v.x < e ? m[2][0] - v.labelDistance - d - v.labelMargin : d + r - v.labelMargin - m[2][0] - v.labelDistance : v.x < e ? v.x - d - v.bleedMargin : d + r - v.x - v.bleedMargin) < v.textRect.width && (v.text = s.truncateText(v.text, _, v.font),
                        "edge" === v.labelAlignTo && (x = s.getWidth(v.text, v.font)));
                    var b = m[1][0] - m[2][0];
                    y ? v.x < e ? m[2][0] = d + v.labelMargin + x + v.labelDistance : m[2][0] = d + r - v.labelMargin - x - v.labelDistance : (v.x < e ? m[2][0] = v.x + v.labelDistance : m[2][0] = v.x - v.labelDistance,
                            m[1][0] = m[2][0] + b),
                        m[1][1] = m[2][1] = v.y
                }
            }
    ...
    function r(t, e, i, n, a, r) {
        ...
        h.each(function(n) {
            ...
            if (C = d(C, i), !(o.angle < g)) {
                ...
                if ("center" === v)
                    ...
                    if (k = E + 3 * A,
                        ...
                        var N = E + A * (S + e - o.r),
                            ...
                            F = N + (A < 0 ? -1 : 1) * C,
                            V = B;
                        k = "edge" === _ ? A < 0 ? a + y : a + i - y : F + (A < 0 ? -m : m),
                            I = V,
                            T = [
                                [E, z],
                                [N, B],
                ...
                H = "number" == typeof q ? q * (Math.PI / 180) : q ? A < 0 ? -M + Math.PI : -M : 0,
                    p = !!H,
                    o.label = {
                        x: k,
                        y: I,
                ...
                if (A <= .001) {
                    ...
                    e.each(o, function(t, i) {
                        if (!isNaN(t)) {
                            ...
                            n.angle = R,
                                n.startAngle = b + O * i * R,
                                n.endAngle = b + O * (i + 1) * R
                        }
                    })
                } else
                    k = A / L,
    ...
    function n(t, e, i) {
        var n = e.getBoxLayoutParams(),
            ...
            d = r(n, a, o);
        s(e.get("orient"), t, e.get("itemGap"), d.width, d.height),
            l(t, n, a, o)
    }
    ...
    var n = i(630),
        o = {
            updateSelectedMap: function(t) {
                this._targetList = n.isArray(t) ? t.slice() : [],
    ...
    var o = i(788),
        a = i(645);
    n.registerProcessor(n.PRIORITY.PROCESSOR.SERIES_FILTER, o),
    ...
    var n = i(639),
        ...
        c = n.extendComponentModel({
            ...
            mergeOption: function(t) {
                c.superCall(this, "mergeOption", t),
                    this._updateSelector(t)
            },
            _updateSelector: function(t) {
                var e = t.selector;
                !0 === e && (e = t.selector = ["all", "inverse"]),
                    o.isArray(e) && o.each(e, function(t, i) {
                        o.isString(t) && (t = {
                                type: t
                            }),
    ...
    var s = i(634),
        ...
        y = l.extendComponentView({
            ...
            newlineDisabled: !1,
            init: function() {
                this.group.add(this._contentGroup = new _),
                    this._backgroundEl,
                    this.group.add(this._selectorGroup = new _),
            ...
            render: function(t, e, i) {
                ...
                if (this._isFirstRender = !1,
                    ...
                    this.group.attr("position", [v.x - f.x, v.y - f.y]),
                        this.group.add(this._backgroundEl = p(f, t))
                }
            },
            resetInner: function() {
                    ...
                    m(e.getData(), function(s, l) {
                        ...
                        if (!h.get(d))
                            if (u) {
                                ...
                                "function" == typeof m && (m = m(u.getDataParams(0))),
                                    "function" == typeof y && (y = y(u.getDataParams(0)));
                                var x = g.getVisual("legendSymbol") || "roundRect",
                                    b = g.getVisual("symbol"),
                                    w = this._createItem(d, l, s, e, x, b, t, m, y, f);
                                w.on("click", v(o, d, null, n, p)).on("mouseover", v(a, u.name, null, n, p)).on("mouseout", v(r, u.name, null, n, p)),
                                    h.set(d, !0)
                            } else
                                i.eachRawSeries(function(i) {
                                    if (!h.get(d) && i.legendVisualProvider) {
                                        ...
                                        this._createItem(d, l, s, e, "roundRect", null, t, g, m, f).on("click", v(o, null, d, n, p)).on("mouseover", v(a, null, d, n, p)).on("mouseout", v(r, null, d, n, p)),
                                            h.set(d, !0)
                                    }
                                }, this)
                    }, this),
                    s && this._createSelector(s, e, n, l, u)
            },
            ...
            _createItem: function(t, e, i, o, a, r, s, l, u, f) {
                ...
                var A = "left" === s ? p + 5 : -5,
                    ...
                    P = o.get("formatter"),
                    O = t;
                "string" == typeof P && P ? O = P.replace("{name}", null != t ? t : "") : "function" == typeof P && (O = P(t)),
                    w.add(new h.Text({
            ...
            layoutInner: function(t, e, i, n, o, a) {
                ...
                if (o) {
                    ...
                    return _[p] = l[p] + h + u[p],
                        _[v] = Math.max(l[v], u[v]),
                        _[m] = Math.min(0, u[m] + c[1 - f]),
                        _
                }
                return r.attr("position", d),
    ...
    function n(t, e, i) {
        ...
        return i.eachComponent("legend", function(i) {
                r && null != n ? i[n ? "select" : "unSelect"](e.name) : "allSelect" === t || "inverseSelect" === t ? i[t]() : (i[t](e.name),
    ...
    o.registerAction("legendToggleSelect", "legendselectchanged", a.curry(n, "toggleSelected")),
        o.registerAction("legendAllSelect", "legendselectall", a.curry(n, "allSelect")),
        o.registerAction("legendInverseSelect", "legendinverseselect", a.curry(n, "inverseSelect")),
        ...
        if (t.onBand && !i && a) {
            ...
            if (1 === a)
                ...
                r(e, function(t) {
                    ...
                    l = 1 + t.scale.getExtent()[1] - e[a - 1].tickValue,
                    s = {
            ...
            var f = d[0] > d[1];
            o(e[0].coord, d[0]) && (n ? e[0].coord = d[0] : e.shift()),
                n && o(d[0], e[0].coord) && e.unshift({
                    coord: d[0]
                }),
                o(d[1], s.coord) && (n ? s.coord = d[1] : e.pop()),
                n && o(s.coord, d[1]) && e.push({
                    coord: d[1]
                })
        }
    }
    ...
    m.prototype = {
        ...
        dataToCoord: function(t, e) {
            var i = this._extent,
                o = this.scale;
            return t = o.normalize(t),
                this.onBand && "ordinal" === o.type && (i = i.slice(),
                    n(i, o.count())),
                d(t, v, i, e)
        },
        ...
        getTicksCoords: function(t) {
            ...
            return o(this, a, e.get("alignWithLabel"), t.clamp),
                a
        },
    ...
    var n = i(630),
        o = {
            getMin: function(t) {
                ...
                return this.axis && null != i && "dataMin" !== i && "function" != typeof i && !n.eqNaN(i) && (i = this.axis.scale.parse(i)),
                    i
            },
            getMax: function(t) {
                var e = this.option,
                    i = t || null == e.rangeEnd ? e.max : e.rangeEnd;
                return this.axis && null != i && "dataMax" !== i && "function" != typeof i && !n.eqNaN(i) && (i = this.axis.scale.parse(i)),
                    i
            },
    ...
    function r(t, e) {
        ...
        if (o)
            return o;
        var a, r;
        return m.isFunction(n) ? a = v(t, n) : (r = "auto" === n ? h(t) : n,
                a = g(t, r)),
            c(i, n, {
                labels: a,
    ...
    function f(t) {
        ...
        var b = Math.max(0, Math.floor(Math.min(y, x))),
            ...
            T = S.lastTickCount;
        return null != I && null != T && Math.abs(I - b) <= 1 && Math.abs(T - r) <= 1 && I > b && S.axisExtend0 === C[0] && S.axisExtend1 === C[1] ? b = I : (S.lastTickCount = r,
                S.lastAutoInterval = b,
                S.axisExtend0 = C[0],
                S.axisExtend1 = C[1]),
            b
    }
    ...
    function g(t, e, i) {
        ...
        f && u !== r[0] && n(r[0]);
        for (var g = u; g <= r[1]; g += d)
            n(g);
        return p && g - d !== r[1] && n(r[1]),
            l
    }
    ...
    var m = i(630),
        ...
        k = x();
    e.createAxisLabels = n,
        e.createAxisTicks = o,
        e.calculateCategoryInterval = f
}, function(t, e, i) {
    function n(t, e, i) {
        if (this.name = t,
            this.geometries = e,
    ...
    n.prototype = {
        ...
        getBoundingRect: function() {
            ...
            return 0 === u && (i[0] = i[1] = n[0] = n[1] = 0),
                this._rect = new o(i[0], i[1], n[0] - i[0], n[1] - i[1])
        },
        contain: function(t) {
        ...
        transformTo: function(t, e, i, n) {
            ...
            for (var l = new o(t, e, i, n), d = a.calculateTransform(l), u = this.geometries, c = 0; c < u.length; c++)
                if ("polygon" === u[c].type) {
                    for (var h = u[c].exterior, f = u[c].interiors, p = 0; p < h.length; p++)
                        r.applyTransform(h[p], h[p], d);
                    for (var g = 0; g < (f ? f.length : 0); g++)
                        for (var p = 0; p < f[g].length; p++)
                            r.applyTransform(f[g][p], f[g][p], d)
                }
            a = this._rect,
                a.copy(l),
    ...
    function a(t, e) {
        return n(t),
            r.map(r.filter(t.features, function(t) {
    ...
    n.prototype = {
        ...
        execute: function() {
            var t, e = this._old,
                ...
                r = [],
                s = [];
            for (o(e, n, r, "_oldKeyGetter", this),
                o(i, a, s, "_newKeyGetter", this),
                t = 0; t < e.length; t++) {
                var l = r[t],
                    d = a[l];
                if (null != d) {
                ...
                if (a.hasOwnProperty(l)) {
                    ...
                    if (d.length)
                        for (var c = 0, u = d.length; c < u; c++)
                            this._add && this._add(d[c]);
                    else
                        this._add && this._add(d)
                }
            }
        }
    };
    ...
    u.getOrdinal = function(t) {
        ...
        u.parseAndCollect = function(t) {
            ...
            var n = o(this);
            return e = n.get(t),
                null == e && (i ? (e = this.categories.length,
                    this.categories[e] = t,
                    n.set(t, e)) : e = NaN),
                e
        };
    ...
    var r = i(630),
        ...
        c = i(647);
    c.getLayoutRect,
        e.getLayoutRect = c.getLayoutRect;
    var h = i(677),
        f = h.enableDataStack,
    ...
    e.createList = n,
        e.dataStack = y,
        e.createScale = o,
        e.mixinAxisModelCommonMethods = a
}, function(t, e, i) {
    function n(t) {
    ...
    var g = i(630),
        ...
        S = {
            ...
            reset: function(t) {
                function e(t, e) {
                    for (var i, l = t.count, u = new w(2 * l), h = new w(2 * l), f = new w(l), m = [], _ = [], y = 0, x = 0; null != (i = t.next());)
                        _[g] = e.get(s, i),
                        _[1 - g] = e.get(d, i),
                        m = n.dataToPoint(_, null, m),
                        h[y] = c ? o.x + o.width : m[0],
                        u[y++] = m[0],
                        h[y] = c ? m[1] : o.y + o.height,
                        u[y++] = m[1],
                        f[x++] = i;
                    e.setLayout({
                        largePoints: u,
    ...
    e.getLayoutOnAxis = a,
        e.prepareLayoutBarSeries = r,
        e.makeColumnLayout = l,
        e.retrieveColumnLayout = u,
        e.layout = c,
        e.largeLayout = S
}, function(t, e, i) {
    function n(t, e) {
    ...
    function o(t, e, i) {
        ...
        return o || (o = t),
            ...
            h([o].concat(a).concat(d.map(r, function(t) {
                return t.option
            })), function(t) {
                h(e, function(e) {
                    e(t, i)
        ...
        e = e || {},
            h(e, function(e, i) {
                if (null != e) {
                    var n = t[i];
                    if (c.hasClass(i)) {
                        e = u.normalizeToArray(e),
                            n = u.normalizeToArray(n);
    ...
    n.prototype = {
        ...
        getMediaOption: function(t) {
            ...
            for (var d = 0, u = n.length; d < u; d++)
                a(n[d].query, e, i) && r.push(d);
            return !r.length && o && (r = [-1]),
                r.length && !s(r, this._currentMediaIndices) && (l = p(r, function(t) {
    ...
    var c = i(634),
        ...
        R = x.extend({
            ...
            init: function(t, e, i, o) {
                ...
                l(s, this),
                    this.dataTask.context.data = s,
                    O(this).dataBeforeProcessed = s,
                    n(this)
            },
            mergeDefaultAndTheme: function(t, e) {
                var i = this.layoutMode,
                    n = i ? C(t) : {},
                    o = this.subType;
                x.hasClass(o) && (o += "Series"),
                    h.merge(t, e.getTheme().get(this.subType)),
                    h.merge(t, this.getDefaultOption()),
                    y.defaultEmphasis(t, "label", ["show"]),
                    this.fillDataTextStyle(t.data),
                    i && k(t, n, i)
            },
            mergeOption: function(t, e) {
                t = h.merge(this.option, t, !0),
                    this.fillDataTextStyle(t.data);
                var i = this.layoutMode;
                i && k(this.option, t, i),
                    M(this);
                ...
                l(o, this),
                    ...
                    O(this).dataBeforeProcessed = o,
                    n(this)
            },
            fillDataTextStyle: function(t) {
                if (t && !h.isTypedArray(t))
                    for (var e = ["show"], i = 0; i < t.length; i++)
                        t[i] && t[i].label && y.defaultEmphasis(t[i], "label", e)
            },
            ...
            formatTooltip: function(t, e, i, n) {
                ...
                h.isObject(x) && x.colorStops && (x = (x.colorStops[0] || {}).color),
                    x = x || "transparent";
    ...
    var n = i(650),
        ...
        c = {
            ...
            getFormattedLabel: function(t, e, i, n, a) {
                ...
                return "function" == typeof c ? (d.status = e,
                    d.dimensionIndex = n,
                    c(d)) : "string" == typeof c ? s(c, d).replace(u, function(e, i) {
                    var n = i.length;
    ...
    function o(t) {
        var e = t.get("coordinateSystem"),
            ...
            o = u[e];
        if (o)
            return o(t, i, i.axisMap, i.categoryAxisMap),
                i
    }
            ...
            parallel: function(t, e, i, n) {
                ...
                d(r.parallelAxisIndex, function(t, r) {
                    var l = o.getComponent("parallelAxis", t),
                        d = s[r];
                    i.set(d, l),
                        a(l) && null == e.firstCategoryDimIndex && (n.set(d, l),
                            e.firstCategoryDimIndex = r)
                })
            }
        };
        ...
        if (e)
            for (var i = 0, n = v.length; i < n; i++) {
                var o = v[i],
                    ...
                    r = e.emphasis;
                a && a[o] && (t[o] = t[o] || {},
                        t[o].normal ? h.merge(t[o].normal, a[o]) : t[o].normal = a[o],
                        a[o] = null),
                    r && r[o] && (t[o] = t[o] || {},
                        t[o].emphasis ? h.merge(t[o].emphasis, r[o]) : t[o].emphasis = r[o],
                        r[o] = null)
            }
    }
    ...
    function l(t) {
        if (g(t)) {
            n(t),
                ...
                r(t, "edgeLabel"),
                t.emphasis && (r(t.emphasis, "label"),
                    r(t.emphasis, "upperLabel"),
                    r(t.emphasis, "edgeLabel"));
            var e = t.markPoint;
            e && (n(e),
                s(e));
            var i = t.markLine;
            ...
            var e = t.markPoint;
            if (e && e.data)
                for (var f = e.data, c = 0; c < f.length; c++)
                    s(f[c]);
            var i = t.markLine;
            if (i && i.data)
                for (var p = i.data, c = 0; c < p.length; c++)
                    h.isArray(p[c]) ? (s(p[c][0]),
                        s(p[c][1])) : s(p[c]);
            "gauge" === t.type ? (r(t, "axisLabel"),
                r(t, "title"),
                r(t, "detail")) : "treemap" === t.type ? (o(t.breadcrumb, "itemStyle"),
                h.each(t.levels, function(t) {
                    a(t)
    ...
    function c(t, e) {
        ...
        e && i.push("valueAxis", "categoryAxis", "logAxis", "timeAxis"),
            p(i, function(e) {
                p(d(t[e]), function(t) {
                    t && (r(t, "axisLabel"),
                        r(t.axisPointer, "label"))
                })
            }),
            p(d(t.parallel), function(t) {
                var e = t && t.parallelAxisDefault;
                r(e, "axisLabel"),
                    r(e && e.axisPointer, "label")
            }),
            ...
            p(d(t.timeline), function(t) {
                ...
                h.isArray(e) && h.each(e, function(t) {
                    h.isObject(t) && (o(t, "label"),
                        o(t, "itemStyle"))
                })
            }),
            p(d(t.toolbox), function(t) {
                o(t, "iconStyle"),
                    p(t.feature, function(t) {
                        o(t, "iconStyle")
                    })
            }),
            r(u(t.axisPointer), "label"),
            r(u(t.tooltip).axisPointer, "label")
    }
    var h = i(630),
        f = i(631),
        p = h.each,
            ...
            var n = [],
                ...
                l = r.map(a, function(a, l, d) {
                    ...
                    for (var f = NaN, p = i - 1; p >= 0; p--) {
                        var g = t[p];
                        if (s || (h = g.data.rawIndexOf(g.stackedByDimension, c)),
                            h >= 0) {
        ...
        v = a.extend({
            ...
            getTicks: function(t) {
                ...
                return o.map(d.getTicks.call(this, t), function(t) {
                    ...
                    return o = t === i[0] && e.__fixMin ? n(o, a[0]) : o,
                        o = t === i[1] && e.__fixMax ? n(o, a[1]) : o
                }, this)
            },
            getMinorTicks: d.getMinorTicks,
            getLabel: d.getLabel,
            scale: function(t) {
                return t = l.scale.call(this, t),
                    p(this.base, t)
            },
            setExtent: function(t, e) {
                var i = this.base;
            ...
            getExtent: function() {
                ...
                var i = this._originalScale,
                    o = i.getExtent();
                return i.__fixMin && (e[0] = n(e[0], o[0])),
                    i.__fixMax && (e[1] = n(e[1], o[1])),
                    e
            },
            unionExtent: function(t) {
            ...
            niceTicks: function(t) {
                ...
                if (!(i === 1 / 0 || i <= 0)) {
                    var n = r.quantity(i),
                        o = t / i * n;
                    for (o <= .5 && (n *= 10); !isNaN(n) && Math.abs(n) < 1 && Math.abs(n) > 0;)
                        n *= 10;
        ...
        s = o.extend({
            ...
            contain: function(t) {
                return t = this.parse(t),
                    r.contain.call(this, t) && null != this._ordinalMeta.categories[t]
            },
    ...
    var n = i(630),
        ...
        h = s.extend({
            ...
            niceExtent: function(t) {
                ...
                t.fixMin || (e[0] = o.round(u(e[0] / n) * n)),
                    t.fixMax || (e[1] = o.round(d(e[1] / n) * n))
            },
            niceTicks: function(t, e, i) {
                t = t || 10;
                var n = this._extent,
        ...
        y(e, function(e, s) {
                if (!o.visualType || o.visualType === e.visualType) {
                    ...
                    if (u) {
                        ...
                        d && d.each(function(s, l) {
                            a(o, s) && s.dirty();
                            var d = t.getPerformArgs(s, o.block);
                            d.skip = !e.performRawSeries && i.isSeriesFiltered(s.context.model),
                                O(s, n),
                                r |= s.perform(d)
                        })
                }
    ...
    function r(t, e, i, n, o) {
        ...
        var d = r.agentStubMap = r.agentStubMap || w(),
            ...
            f = !0,
            p = e.modifyOutputEnd;
        c ? n.eachRawSeriesByType(c, a) : h ? h(n, o).each(a) : (f = !1,
            y(n.getSeries(), a));
    ...
    P.restoreData = function(t, e) {
        ...
        P.prepareStageTasks = function() {
            ...
            y(this._allHandlers, function(n) {
                ...
                n.reset && a(this, n, o, e, i),
                    n.overallReset && r(this, n, o, e, i)
            }, this)
        },
    ...
    m(z, D),
        m(N, M),
        z.eachSeriesByType = z.eachRawSeriesByType = function(t) {
            E = t
        },
    ...
    function n(t, e) {
        ...
        function n(t) {
            var e = l.get(t);
            if (null == e) {
                for (var i = t.split("."), n = a.aria, o = 0; o < i.length; ++o)
                    n = n[i[o]];
                return n
            }
            return e
        ...
        if (l.get("show")) {
            if (l.get("description"))
                return void t.setAttribute("aria-label", l.get("description"));
            var d = 0;
                ...
                u += i(n(d > 1 ? "series.multiple.prefix" : "series.single.prefix"), {
                    ...
                    e.eachSeries(function(t, e) {
                        if (e < f) {
                            ...
                            o = n(a ? l + "withName" : l + "withoutName"),
                                o = i(o, {
                            ...
                            var u = t.getData();
                            window.data = u,
                                u.count() > c ? o += i(n("data.partialData"), {
                                    displayCnt: c
                                }) : o += n("data.allData");
                            ...
                            o += h.join(n("data.separator.middle")) + n("data.separator.end"),
                                g.push(o)
                        }
                    }),
                    u += g.join(n("series.multiple.separator.middle")) + n("series.multiple.separator.end"),
                    t.setAttribute("aria-label", u)
            }
        }
    }
    var o = i(630),
    ...
    var n = i(692),
        ...
        r = {
            ...
            reset: function(t, e) {
                ...
                r && !s || (r = t.getColorFromPalette(t.name, null, e.getSeriesCount())),
                    i.setVisual("color", r);
    ...
    v.prototype = {
            ...
            mousemove: function(t) {
                var e = t.zrX,
                    ...
                    o = this._hovered,
                    a = o.target;
                a && !a.__zr && (o = this.findHover(o.x, o.y),
                    a = o.target);
                var r = this._hovered = n ? {
                    ...
                    l = r.target,
                    d = this.proxy;
                d.setCursor && d.setCursor(l ? l.cursor : "default"),
                    a && l !== a && this.dispatchToElement(o, "mouseout", t),
                    this.dispatchToElement(r, "mousemove", t),
                    l && l !== a && this.dispatchToElement(r, "mouseover", t)
            },
            mouseout: function(t) {
            ...
            dispatchToElement: function(t, e, i) {
                ...
                var o = t.target;
                if (!o || !o.silent) {
                    for (var a = "on" + e, r = n(e, t, i); o && (o[a] && (r.cancelBubble = o[a].call(o, r)),
                            o.trigger(e, r),
                            o = o.parent, !r.cancelBubble);)
                    ;
            ...
            findHover: function(t, e, i) {
                for (var n = this.storage.getDisplayList(), o = {
                    ...
                    var s;
                    if (n[a] !== i && !n[a].ignore && (s = r(n[a], t, e)) && (!o.topTarget && (o.topTarget = n[a]),
                            s !== p)) {
                        o.target = n[a];
                        break
                    }
        ...
        l.each(["click", "mousedown", "mouseup", "mousewheel", "dblclick", "contextmenu"], function(t) {
            v.prototype[t] = function(e) {
                var i, n, o = e.zrX,
                    a = e.zrY,
                    r = s(this, o, a);
                if ("mouseup" === t && r || (i = this.findHover(o, a),
                        n = i.target),
                    "mousedown" === t)
                    this._downEl = n,
                    ...
                    if (this._downEl !== this._upEl || !this._downPoint || d.dist(this._downPoint, [e.zrX, e.zrY]) > 4)
                        return;
    ...
    var a = i(630),
        ...
        u = function(t, e, i) {
            var r;
            i = i || s,
                "string" == typeof t ? r = o(t, e, i) : a.isObject(t) && (r = t,
                    t = r.id),
                this.id = t,
                this.dom = r;
            var l = r.style;
    ...
    u.prototype = {
        ...
        createBackBuffer: function() {
            var t = this.dpr;
            this.domBack = o("back-" + this.id, this.painter, t),
        ...
        clear: function(t, e) {
            ...
            if (r && (this.domBack || this.createBackBuffer(),
                ...
                e.colorStops ? (c = e.__canvasGradient || l.getGradient(n, e, {
                        ...
                        e.__canvasGradient = c) : e.image && (c = d.prototype.getCanvasPattern.call(e, n)),
                    n.save(),
                    n.fillStyle = c || e,
                    n.fillRect(0, 0, o, a),
                    n.restore()
    ...
    function a(t, e, i) {
        return y.copy(t.getBoundingRect()),
            t.transform && y.applyTransform(t.transform),
            x.width = e,
            x.height = i, !y.intersect(x)
    }
    ...
    var d = i(661),
        ...
        b = function(t, e, i) {
            ...
            this._opts = i = c.extend({}, i || {}),
                this.dpr = i.devicePixelRatio || u,
    ...
    b.prototype = {
        ...
        refreshHover: function() {
            ...
            if (i && i.clear(),
                e) {
                p(t, this.storage.displayableSortFunc),
        ...
        _doPaintList: function(t, e) {
            ...
            for (var r = !0, s = 0; s < i.length; s++) {
                ...
                for (var v = u; v < a.__endIndex; v++) {
                    var m = t[v];
                    if (this._doPaintEl(m, a, e, d),
                        m.__dirty = m.__dirtyText = !1,
                        h && Date.now() - f > 15)
                        break
                }
                a.__drawIndex = v,
                    a.__drawIndex < a.__endIndex && (r = !1),
                    d.prevElClipPaths && l.restore(),
                    l.restore()
            }
        ...
        getLayer: function(t, e) {
            ...
            return i || (i = new g("zr_" + t, this, this.dpr),
                    i.zlevel = t,
                    i.__builtin__ = !0,
                    this._layerConfig[t] ? c.merge(i, this._layerConfig[t], !0) : this._layerConfig[t - .01] && c.merge(i, this._layerConfig[t - .01], !0),
                    e && (i.virtual = e),
            ...
            for (var o, a = null, r = 0, i = 0; i < t.length; i++) {
                ...
                o !== l && (o = l,
                    ...
                    n.incremental ? (s = this.getLayer(l + .001, this._needsManuallyCompositing),
                        s.incremental = !0,
                        r = 1) : s = this.getLayer(l + (r > 0 ? .01 : 0), this._needsManuallyCompositing),
                    s.__builtin__ || h("ZLevel " + l + " has been used by unkown layer " + s.id),
                    s !== a && (s.__used = !0,
    ...
    l.prototype = {
        ...
        updateDisplayList: function(t) {
            this._displayListLen = 0;
            for (var e = this._roots, i = this._displayList, o = 0, r = e.length; o < r; o++)
                this._updateAndAddDisplayable(e[o], null, t);
            i.length = this._displayListLen,
                a.canvasSupported && s(i, n)
        },
        ...
        addRoot: function(t) {
            t.__storage !== this && (t instanceof r && t.addChildrenToStorage(this),
                this.addToStorage(t),
                this._roots.push(t))
        },
        delRoot: function(t) {
            ...
            if (t instanceof Array)
                ...
                a >= 0 && (this.delFromStorage(t),
                    this._roots.splice(a, 1),
                    t instanceof r && t.delChildrenFromStorage(this))
            }
        },
    ...
    var i = {
            ...
            elasticIn: function(t) {
                ...
                return 0 === t ? 0 : 1 === t ? 1 : (!i || i < 1 ? (i = 1,
                    e = .1) : e = .4 * Math.asin(1 / i) / (2 * Math.PI), -i * Math.pow(2, 10 * (t -= 1)) * Math.sin((t - e) * (2 * Math.PI) / .4))
            },
    ...
    function a(t, e, i, n, a, r, s, l, d, u) {
        if (u > e && u > n && u > r && u > l || u < e && u < n && u < r && u < l)
            return 0;
        ...
        for (var h, f, p = 0, g = -1, v = 0; v < c; v++) {
            var m = S[v],
                y = 0 === m || 1 === m ? .5 : 1;
            _.cubicAt(t, i, a, s, m) < d || (g < 0 && (g = _.cubicExtrema(e, n, r, l, C),
                    C[1] < C[0] && g > 1 && o(),
                    h = _.cubicAt(e, n, r, l, C[0]),
                    g > 1 && (f = _.cubicAt(e, n, r, l, C[1]))),
                2 === g ? m < C[0] ? p += h < e ? y : -y : m < C[1] ? p += f < h ? y : -y : p += l < f ? y : -y : m < C[0] ? p += h < e ? y : -y : p += l < h ? y : -y)
        }
        return p
    }
        ...
        for (var c = 0, h = 0; h < 2; h++) {
            ...
            if (f + t > r) {
                var p = Math.atan2(s, f),
                    u = a ? 1 : -1;
                p < 0 && (p = b + p),
                    (p >= n && p <= o || p + b >= n && p + b <= o) && (p > Math.PI / 2 && p < 1.5 * Math.PI && (u = -u),
                        c += u)
            }
        }
        return c
    ...
    function l(t, e, i, o, l) {
        for (var d = 0, u = 0, c = 0, v = 0, m = 0, _ = 0; _ < t.length;) {
            var b = t[_++];
            switch (b === x.M && _ > 1 && (i || (d += y(u, c, v, m, o, l))),
                1 === _ && (u = t[_],
                    c = t[_ + 1],
                    v = u,
                    m = c),
                ...
                case x.L:
                    if (i) {
                        if (h.containStroke(u, c, t[_], t[_ + 1], e, o, l))
                            return !0
                    } else
                        d += y(u, c, t[_], t[_ + 1], o, l) || 0;
                    u = t[_++],
                        c = t[_++];
                    break;
                case x.C:
                    if (i) {
                        if (f.containStroke(u, c, t[_++], t[_++], t[_++], t[_++], t[_], t[_ + 1], e, o, l))
                            return !0
                    } else
                        d += a(u, c, t[_++], t[_++], t[_++], t[_++], t[_], t[_ + 1], o, l) || 0;
                    u = t[_++],
                        c = t[_++];
                    break;
                case x.Q:
                    if (i) {
                        if (p.containStroke(u, c, t[_++], t[_++], t[_], t[_ + 1], e, o, l))
                            return !0
                    } else
                        d += r(u, c, t[_++], t[_++], t[_], t[_ + 1], o, l) || 0;
                    u = t[_++],
                        c = t[_++];
                    break;
                case x.A:
                    ...
                    var D = 1 - t[_++],
                        M = Math.cos(I) * C + w,
                        A = Math.sin(I) * k + S;
                    _ > 1 ? d += y(u, c, M, A, o, l) : (v = M,
                        m = A);
                    var L = (o - w) * k / C + w;
                    if (i) {
                        if (g.containStroke(w, S, k, I, I + T, D, e, L, l))
                            return !0
                    } else
                        d += s(w, S, k, I, I + T, D, L, l);
                    u = Math.cos(I + T) * C + w,
                        c = Math.sin(I + T) * k + S;
                    break;
                case x.R:
                    ...
                    var P = t[_++],
                        ...
                        A = m + O;
                    if (i) {
                        if (h.containStroke(v, m, M, m, e, o, l) || h.containStroke(M, m, M, A, e, o, l) || h.containStroke(M, A, v, A, e, o, l) || h.containStroke(v, A, v, m, e, o, l))
                            return !0
                    } else
                        d += y(M, m, M, A, o, l),
                        d += y(v, A, v, m, o, l);
                ...
                case x.Z:
                    if (i) {
                        if (h.containStroke(u, c, v, m, e, o, l))
                            return !0
                    } else
                        d += y(u, c, v, m, o, l);
                    u = v,
        ...
        return i || n(c, m) || (d += y(u, c, v, m, o, l) || 0),
            0 !== d
    }
    ...
    function o(t, e, i) {
        ...
        for (var s = 1; s < t.length; s++) {
            var l = t[s];
            o += a(r[0], r[1], l[0], l[1], e, i),
                r = l
        }
        var d = t[0];
        return n(r[0], d[0]) && n(r[1], d[1]) || (o += a(r[0], r[1], d[0], d[1], e, i)),
            0 !== o
    }
    var a = i(715),
        r = 1e-8;
    ...
    function a(t, e) {
        ...
        for (var n = ["left", "right"], o = ["top", "bottom"], a = 0; a < 4; a++) {
            var r = document.createElement("div"),
                ...
                l = a % 2,
                d = (a >> 1) % 2;
            s.cssText = ["position: absolute", "visibility: hidden", "padding: 0", "margin: 0", "border-width: 0", "user-select: none", "width:0", "height:0", n[l] + ":0", o[d] + ":0", n[1 - l] + ":auto", o[1 - d] + ":auto", ""].join("!important;"),
                t.appendChild(r),
                i.push(r)
        }
        return i
    ...
    function r(t, e, i) {
        for (var n = i ? "invTrans" : "trans", o = e[n], a = e.srcCoords, r = !0, s = [], l = [], d = 0; d < 4; d++) {
            ...
            s.push(f, p),
                r = r && a && f === a[h] && p === a[h + 1],
                l.push(t[d].offsetLeft, t[d].offsetTop)
        }
    ...
    var l = i(637),
        ...
        c = "___zrEVENTSAVED",
        h = [];
    e.transformLocalCoord = n,
        e.transformCoordWithViewport = o,
        e.isCanvasEl = s
}, function(t, e) {
    function i(t, e, n, a, r, s) {
        ...
        for (var c = a | 1 << n, h = n + 1; a & 1 << h;)
            h++;
        for (var f = 0, p = 0, g = 0; p < d; p++) {
            var v = 1 << p;
            v & r || (f += (g % 2 ? -1 : 1) * t[n][p] * i(t, e - 1, h, c, r | v, s),
                g++)
        }
        return s[l] = f,
            f
    ...
    function n(t, e) {
        ...
        if (0 !== a) {
            for (var r = [], s = 0; s < 8; s++)
                for (var l = 0; l < 8; l++)
                    null == r[l] && (r[l] = 0),
                    r[l] += ((s + l) % 2 ? -1 : 1) * i(n, 7, 0 === s ? 1 : 0, 1 << s, 1 << l, o) / a * e[s];
            return function(t, e, i) {
                var n = e * r[6] + i * r[7] + 1;
                t[0] = (e * r[0] + i * r[1] + r[2]) / n,
                    t[1] = (e * r[3] + i * r[4] + r[5]) / n
            }
        }
    }
    var o = Math.log(2);
    ...
    function c(t, e) {
        function i(i) {
            function n(n) {
                n = b(n),
                    l(t, n.target) || (n = s(t, n),
                        e.domHandlers[i].call(t, n))
            }
            h(e, i, n, {
                capture: !0
            })
    ...
    function h(t, e, i, o) {
        t.mounted[e] = i,
            t.listenerOpts[e] = o,
            _(t.domTarget, n(e), i, o)
    }

    function f(t) {
        var e = t.mounted;
        for (var i in e)
            e.hasOwnProperty(i) && y(t.domTarget, n(i), e[i], t.listenerOpts[i]);
        t.mounted = {}
    }

    function p(t, e) {
        if (t._mayPointerCapture = null,
            k && t._pointerCapturing ^ e) {
    ...
    function v(t, e) {
        S.call(this),
            this.dom = t,
            this.painterRoot = e,
            this._localHandlerScope = new g(t, M),
            k && (this._globalHandlerScope = new g(document, A)),
            this._pointerCapturing = !1,
            this._mayPointerCapture = null,
            u(this, this._localHandlerScope)
    }
    var m = i(663),
    ...
    var M = {
        ...
        mousemove: function(t) {
            ...
            !e || t.zrX === e[0] && t.zrY === e[1] || p(this, !0),
        ...
        touchend: function(t) {
            t = x(this.dom, t),
                ...
                M.mouseup.call(this, t), +new Date - this._lastTouchMoment < 300 && M.click.call(this, t)
        },
    ...
    var A = {
        ...
        L = v.prototype;
    L.dispose = function() {
            f(this._localHandlerScope),
                k && f(this._globalHandlerScope)
        },
    ...
    n.prototype.getBoundingRect = function() {
            if (!this._rect) {
                for (var t = new s(1 / 0, 1 / 0, -1 / 0, -1 / 0), e = 0; e < this._displayables.length; e++) {
                    ...
                    i.needLocalTransform() && n.applyTransform(i.getLocalTransform(l)),
                        t.union(n)
                }
                this._rect = t
            }
    ...
    function o(t, e) {
        for (var i = t.length, o = [], a = 0, s = 1; s < i; s++)
            a += r(t[s - 1], t[s]);
        var l = a / 2;
        l = l < i ? i : l;
        for (var s = 0; s < l; s++) {
    ...
    l.prototype = {
        ...
        drawRectText: function(t, e) {
            var i = this.style;
            e = i.textRect || e,
                this.__dirty && n.normalizeTextStyle(i, !0);
            var o = i.text;
            if (null != o && (o += ""),
                n.needDrawText(o, i)) {
                t.save();
                var a = this.transform;
                i.transformText ? this.setTransform(t) : a && (s.copy(e),
                        s.applyTransform(a),
                        e = s),
                    n.renderText(this, t, o, i, e, r),
                    t.restore()
            }
        }
    };
        ...
        p = o.extend({
            ...
            buildPath: function(t, e) {
                var i = e.x1,
                    ...
                    h = e.percent;
                0 !== h && (t.moveTo(i, n),
                    null == u || null == c ? (h < 1 && (s(i, r, o, h, f),
                            r = f[1],
                            o = f[2],
                            s(n, d, a, h, f),
                            d = f[1],
                            a = f[2]),
                        t.quadraticCurveTo(r, d, o, a)) : (h < 1 && (l(i, r, u, o, h, f),
                            r = f[1],
                            u = f[2],
                            o = f[3],
                            l(n, d, c, a, h, f),
        ...
        a = n.extend({
            ...
            buildPath: function(t, e) {
                var i = e.cx,
                    ...
                    d = Math.cos(r),
                    u = Math.sin(r);
                t.moveTo(d * o + i, u * o + n),
                    t.lineTo(d * a + i, u * a + n),
                    t.arc(i, n, a, r, s, !l),
    ...
    function o(t, e, i, n, r, s, l) {
        var d = {},
            u = 0;
        for (var f in n)
            n.hasOwnProperty(f) && (null != i[f] ? c(n[f]) && !h(n[f]) ? o(t, e ? e + "." + f : f, i[f], n[f], r, s, l) : (l ? (d[f] = i[f],
                    a(t, e, f, n[f])) : d[f] = n[f],
                u++) : null == n[f] || l || a(t, e, f, n[f]));
    ...
    p.prototype = {
        ...
        animate: function(t, e) {
            ...
            if (t) {
                ...
                i = o;
            if (!i)
                return void s('Property "' + t + '" is not existed in element ' + o.id);
            var h = o.animators,
                p = new r(i, e);
    ...
    i.prototype = {
        ...
        _dragStart: function(t) {
            ...
            e && (this._draggingTarget = e,
                ...
                this._x = t.offsetX,
                this._y = t.offsetY,
                this.dispatchToElement(n(e, t), "dragstart", t.event))
        },
        _drag: function(t) {
            ...
            if (e) {
                ...
                this._x = i,
                    this._y = o,
                    e.drift(a, r, t),
                    this.dispatchToElement(n(e, t), "drag", t.event);
                var s = this.findHover(i, o, e).target,
                    l = this._dropTarget;
                this._dropTarget = s,
                    e !== s && (l && s !== l && this.dispatchToElement(n(l, t), "dragleave", t.event),
                        s && s !== l && this.dispatchToElement(n(s, t), "dragenter", t.event))
            }
        },
        _dragEnd: function(t) {
            var e = this._draggingTarget;
            e && (e.dragging = !1),
                this.dispatchToElement(n(e, t), "dragend", t.event),
                this._dropTarget && this.dispatchToElement(n(this._dropTarget, t), "drop", t.event),
    ...
    function n(t) {
        for (A(t) && (t = (new DOMParser).parseFromString(t, "text/xml")),
    ...
    function r(t, e) {
        t && t.__inheritedStyle && (e.__inheritedStyle || (e.__inheritedStyle = {}),
            P(e.__inheritedStyle, t.__inheritedStyle))
    }
    ...
    function l(t, e, i, n) {
        ...
        var f = e.style;
        null != o.fill && f.set(l, d(o.fill, i)),
            null != o.stroke && f.set(h, d(o.stroke, i)),
            ...
            R(["lineDashOffset", "lineCap", "lineJoin", "fontWeight", "fontFamily", "fontStyle", "textAlign", "textBaseline"], function(t) {
                null != o[t] && f.set(t, o[t])
            }),
            o.lineDash && (e.style.lineDash = O(o.lineDash).split(E)),
            f[h] && "none" !== f[h] && (e[h] = !0),
        ...
        if (i) {
            ...
            for (var a = o.length - 1; a > 0; a -= 2) {
                ...
                switch (n = n || I.create(),
                    ...
                    case "translate":
                        r = O(r).split(E),
                            I.translate(n, n, [parseFloat(r[0]), parseFloat(r[1] || 0)]);
                        break;
                    case "scale":
                        r = O(r).split(E),
                            I.scale(n, n, [parseFloat(r[0]), parseFloat(r[1] || r[0])]);
                        break;
                    case "rotate":
                        r = O(r).split(E),
                            I.rotate(n, n, parseFloat(r[0]));
                        break;
                    case "skew":
                        r = O(r).split(E),
    ...
    function c(t) {
        ...
        var n = {};
        H.lastIndex = 0;
        for (var o; null != (o = H.exec(e));)
            n[o[1]] = o[2];
        for (var a in B)
            B.hasOwnProperty(a) && null != n[a] && (i[B[a]] = n[a]);
        return i
    }
    ...
    o.prototype.parse = function(t, e) {
            ...
            if (u && null != r && null != s && (c = h(u, r, s), !e.ignoreViewBox)) {
                ...
                o = new p,
                    o.add(g),
                    g.scale = c.scale.slice(),
                    g.position = c.position.slice()
            }
